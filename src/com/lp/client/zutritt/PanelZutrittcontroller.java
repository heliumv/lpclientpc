...
public class PanelZutrittcontroller
    extends PanelBasis
{
...
//von hier ...
  ...
  private ZutrittscontrollerDto zutrittscontrollerDto = null;
  public PanelZutrittcontroller(InternalFrame internalFrame, String add2TitleI,
                                Object pk)
      throws Throwable {
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    zutrittscontrollerDto = new ZutrittscontrollerDto();
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws
      Throwable {
    DelegateFactory.getInstance().getZutrittDelegate().removeZutrittscontroller(zutrittscontrollerDto);
  ...
  protected void components2Dto() {
    zutrittscontrollerDto.setCNr(wtfKennung.getText());
    zutrittscontrollerDto.setCBez(wtfBezeichnung.getText());
    zutrittscontrollerDto.setCAdresse(wtfAdresse.getText());

  }


  protected void dto2Components() {
    wtfKennung.setText(zutrittscontrollerDto.getCNr());
    wtfBezeichnung.setText(zutrittscontrollerDto.getCBez());
    wtfAdresse.setText(zutrittscontrollerDto.getCAdresse());
  }
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (zutrittscontrollerDto.getIId() == null) {
        zutrittscontrollerDto.setCBez(wtfBezeichnung.getText());
        zutrittscontrollerDto.setIId(DelegateFactory.getInstance().getZutrittDelegate().
                                     createZutrittscontroller(zutrittscontrollerDto));
        setKeyWhenDetailPanel(zutrittscontrollerDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getZutrittDelegate().updateZutrittscontroller(
            zutrittscontrollerDto);
      }
      super.eventActionSave(e, true);

      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(zutrittscontrollerDto.getIId() + "");
      }
  ...
  private void jbInit()
    ...
    wtfBezeichnung.setColumnsMax(ZutrittscontrollerFac.MAX_ZUTRITTSCONTROLLER_C_BEZ);

    wlaAdresse.setText(LPMain.getInstance().getTextRespectUISPr("pers.zutritt.zutrittscontroller.adresse"));
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      zutrittscontrollerDto = DelegateFactory.getInstance().getZutrittDelegate().
          zutrittscontrollerFindByPrimaryKey( (Integer) key);
