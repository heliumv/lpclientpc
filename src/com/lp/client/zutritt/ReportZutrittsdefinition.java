...
public class ReportZutrittsdefinition
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportZutrittsdefinition(InternalFrameZutritt internalFrame,
                                      String add2Title)
      throws Throwable {
    super(internalFrame, add2Title);
    LPMain.getInstance().getTextRespectUISPr("pers.zutritt.definition");
  ...
  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getZutrittReportDelegate().printZutrittsdefinition();
  }
  ...
  public String getReportname() {
    return ZutrittscontrollerReportFac.REPORT_ZUTRITTDEFINITION;
  }
