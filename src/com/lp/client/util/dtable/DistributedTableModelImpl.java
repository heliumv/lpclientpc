 ...
 * @author werner
 */
public class DistributedTableModelImpl
    extends DefaultTableModel implements DistributedTableModel
{
  /**
	 * 
	 */
...
protected final LpLogger myLogger = (LpLogger) LpLogger.getInstance(this.getClass());
  ...
  public Class getColumnClass(int col) {
    ...
    try {
      if (this.dataSource != null && this.dataSource.getColumnCount() > col
          && col >= 0) {
...
/** @todo JO->JO  PJ 5369 */
   ...
   * @param selectedId the id of the currently selected row in the gui's table.
