...
public class PanelDialogKriterienBestellvorschlagLoeschenBisZu extends
	...
	public PanelDialogKriterienBestellvorschlagLoeschenBisZu(
			InternalFrame internalFrameI) throws Throwable {
		super(internalFrameI, LPMain.getTextRespectUISPr("bes.vorschlaegebisloeschen"));
	    jbInitPanel();
	    initComponents();
	}
	...
	/**
	  ...
	  private void jbInitPanel()
	      throws Throwable {
	    wlaDatum.setText(LPMain.getTextRespectUISPr("bes.vorsclagloeschenbiszeitpunkt"));
