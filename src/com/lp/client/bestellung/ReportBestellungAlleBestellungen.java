...
public class ReportBestellungAlleBestellungen
    extends PanelReportJournalEinkauf
...
public ReportBestellungAlleBestellungen(InternalFrame internalFrame, String add2Title) throws Throwable {
  ...
  public String getReportname() {
    return BestellungReportFac.REPORT_BESTELLUNGEN_ALLE;
  }
  ...
  public JasperPrintLP getReport(String sDrucktype)
    ...
    return DelegateFactory.getInstance().getBestellungDelegate().printBestellungenAlle(krit);
  }
