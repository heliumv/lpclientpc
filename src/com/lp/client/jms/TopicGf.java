...
public class TopicGf extends LPTopic implements ILPTopic {

//	private TopicSubscriber subscrib = null;

	public TopicGf(Desktop desktopI) throws NamingException, ExceptionLP {
		super.desktop = desktopI;
		super.ctx = new InitialContext();
		try {
			super.subscribe(LPTopicGfBean.DESTINATION_TOPIC_NAME_GF, true, this);
