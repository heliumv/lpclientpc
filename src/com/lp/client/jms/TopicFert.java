...
public class TopicFert extends LPTopic implements ILPTopic {

//	private TopicSubscriber subscrib = null;

	public TopicFert(Desktop desktopI) throws NamingException, ExceptionLP {
		super.desktop = desktopI;
		super.ctx = new InitialContext();
		try {
			super.subscribe(LPTopicFertBean.DESTINATION_TOPIC_NAME_FERT, true, this);
