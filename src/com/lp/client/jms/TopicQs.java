...
public class TopicQs extends LPTopic implements ILPTopic {

//	private TopicSubscriber subscrib = null;

	public TopicQs(Desktop desktopI) throws NamingException, ExceptionLP {
		super.desktop = desktopI;
		super.ctx = new InitialContext();
		try {
			super.subscribe(LPTopicQsBean.DESTINATION_TOPIC_NAME_QS, true, this);
