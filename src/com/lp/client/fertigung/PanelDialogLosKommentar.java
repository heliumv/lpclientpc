 ...
 */
public class PanelDialogLosKommentar
...
/** Cache for convenience. */
  ...
  public PanelDialogLosKommentar(InternalFrame internalFrame,
                                         String add2TitleI)
      throws Throwable {
  ...
  private void dto2Components()
      throws Throwable {
      getLpEditor().setText(intFrame.getTabbedPaneLos().getLosDto().getXText());
      setCBestehenderKommentar(intFrame.getTabbedPaneLos().getLosDto().getXText());
  }
  ...
  public void saveKommentar()
    ...
    if (lockMeLos != null) {
      ...
      intFrame.getTabbedPaneLos().getLosDto().setXText(getLpEditor().getText());

    DelegateFactory.getInstance().getFertigungDelegate().updateLosKommentar(intFrame.
