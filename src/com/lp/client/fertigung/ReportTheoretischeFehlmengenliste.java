 ...
 */
public class ReportTheoretischeFehlmengenliste
...
private Integer losIId = null;
  public ReportTheoretischeFehlmengenliste(InternalFrame internalFrame, Integer losIId,
  ...
  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getFertigungDelegate().printTheoretischeFehlmengen(losIId);
  }
