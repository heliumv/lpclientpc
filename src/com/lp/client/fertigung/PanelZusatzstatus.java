...
//von hier ...
  ...
  private ZusatzstatusDto zusatzstatusDto = null;
  public PanelZusatzstatus(InternalFrame internalFrame, String add2TitleI,
                               Object pk)
      throws Throwable {
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    zusatzstatusDto = new ZusatzstatusDto();
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws
      Throwable {
    DelegateFactory.getInstance().getFertigungDelegate().removeZusatzstatus(
        zusatzstatusDto);
  ...
  protected void components2Dto()
      throws Exception {
    zusatzstatusDto.setCBez(wtfBezeichnung.getText());
    zusatzstatusDto.setISort(wnfSortierung.getInteger());

  }


  protected void dto2Components() {
    wtfBezeichnung.setText(zusatzstatusDto.getCBez());
    wnfSortierung.setInteger(zusatzstatusDto.getISort());
  }
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (zusatzstatusDto.getIId() == null) {
        zusatzstatusDto.setCBez(wtfBezeichnung.getText());
        zusatzstatusDto.setIId(DelegateFactory.getInstance().getFertigungDelegate().
                                   createZusatzstatus(zusatzstatusDto));
        setKeyWhenDetailPanel(zusatzstatusDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getFertigungDelegate().updateZusatzstatus(
            zusatzstatusDto);
      }
      super.eventActionSave(e, true);

      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(zusatzstatusDto.getIId() + "");
      }
  ...
  private void jbInit()
    ...
    jpaWorkingOn.add(wlaSort,
                     new GridBagConstraints(0, 1, 1, 1, 0, 0.0
                                            ...
                                            GridBagConstraints.HORIZONTAL,
                                            new Insets(2, 2, 2, 2), 0, 0));
    jpaWorkingOn.add(wnfSortierung,
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_ZUSATZSTATUS;
  }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      clearStatusbar();
      wnfSortierung.setInteger(DelegateFactory.getInstance().getFertigungDelegate().
                               getNextZusatzstatus());
    }
    else {
      zusatzstatusDto = DelegateFactory.getInstance().getFertigungDelegate().
          zusatzstatusFindByPrimaryKey( (Integer) key);
