...
public class ReportMonatsauswertung
...
private WrapperLabel wlaVon = new WrapperLabel();
  ...
  private WrapperCheckBox wcoVerdichtet = new WrapperCheckBox();
  ...
  public ReportMonatsauswertung(InternalFrame internalFrame,
                                    String add2Title)
      throws Throwable {
  ...
  private void jbInit()
    ...
    wcoVerdichtet.setSelected(true);
    wcoVerdichtet.setText(LPMain.getInstance().getTextRespectUISPr("lp.verdichtet"));
    ...
    jpaWorkingOn.add(wlaVon, new GridBagConstraints(0, iZeile, 1, 1, 0.1, 0.0
    ...
    jpaWorkingOn.add(wcoVerdichtet, new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0
            , GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2),
            0, 0));
  ...
  public JasperPrintLP getReport(String sDrucktype)
    ...
    JasperPrintLP jasperPrint = null;
      ...
      return DelegateFactory.getInstance().getFertigungDelegate().
         printMonatsauswertung(wdfVon.getTimestamp(),
                           wdfBisTemp,wcoVerdichtet.isSelected());
