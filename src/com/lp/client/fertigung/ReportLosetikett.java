...
public class ReportLosetikett extends PanelBasis implements PanelReportIfJRDS {
	...
	public ReportLosetikett(InternalFrame internalFrame, String title,
	...
	public String getReportname() {
		return FertigungReportFac.REPORT_LOSETIKETT1;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory
				.getInstance()
				.getFertigungDelegate()
				.printLosEtikett(iLosIId, wnfMenge.getBigDecimal(),
