...
/**
 * <p>Panel zum Bearbeiten der Internen Bestellung</p>
 * <p>Copyright Logistik Pur Software GmbH (c) 2004-2008</p>
 * <p>Erstellungsdatum <I>03. 12. 2005</I></p>
 * <p> </p>
 * @author  Martin Bluehweis
 * @version $Revision: 1.5 $
 */
public class PanelInternebestellung
    extends PanelBasis
{
  /**
	 * 
...
private TabbedPaneInternebestellung tabbedPaneInternebestellung = null;
  ...
  private static final String ACTION_SPECIAL_AUFTRAG =
      "action_special_los_auftrag";
  private static final String ACTION_SPECIAL_AUFTRAGPOSITION =
      "action_special_los_auftragposition";
  ...
  private WrapperGotoButton wbuStueckliste = new WrapperGotoButton(WrapperGotoButton.GOTO_STUECKLISTE_DETAIL);
  ...
  private void jbInit()
    ...
    wtfAuftragBezeichnung.setColumnsMax(AuftragFac.MAX_AUFT_AUFTRAG_PROJEKTBEZEICHNUNG);
    ...
    wdfProduktionsbeginn.getDisplay().addFocusListener(new
        PanelInternebestellung_focusAdapter(this));
    wdfProduktionsende.getDisplay().addFocusListener(new
        PanelInternebestellung_focusAdapter(this));
    ...
    wlaLosgroesse.setMinimumSize(new Dimension(120,
                                               Defaults.getInstance().getControlHeight())); 
    wlaLosgroesse.setPreferredSize(new Dimension(120, 
                                                 Defaults.getInstance().getControlHeight())); 
    wnfLosgroesse.setMinimumSize(new Dimension(100,
                                               Defaults.getInstance().getControlHeight())); 
    wnfLosgroesse.setPreferredSize(new Dimension(100,
                                                 Defaults.getInstance().getControlHeight())); 
    wlaEinheit.setHorizontalAlignment(SwingConstants.LEFT);
    wlaEinheit.setMinimumSize(new Dimension(60, Defaults.getInstance().getControlHeight()));
    wlaEinheit.setPreferredSize(new Dimension(60, Defaults.getInstance().getControlHeight()));
    ...
    this.add(getPanelStatusbar(), new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0
        ...
        new Insets(0, 0, 0, 0), 0, 0));
    iZeile++;
    jPanelWorkingOn.add(wbuAuftrag,
    ...
    jPanelWorkingOn.add(wtfAuftragNummer,
                        new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
                                               ...
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wtfAuftragBezeichnung,
                        new GridBagConstraints(2, iZeile, 3, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    iZeile++;
    jPanelWorkingOn.add(wbuAuftragposition,
                        new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wtfAuftragpositionNummer,
                        new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    ...
    jPanelWorkingOn.add(wtfKunde,
                        new GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0,
                                               ...
                                               new Insets(2, 2, 2, 2), 0, 0));
    iZeile++;
    jPanelWorkingOn.add(wtfAdresse,
                        new GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    ...
    jPanelWorkingOn.add(wlaAbteilung,
                        new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
                                               ...
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wtfAbteilung,
                        new GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    iZeile++;
    jPanelWorkingOn.add(wbuStueckliste,
                        new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wtfStuecklisteNummer,
                        new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wtfStuecklisteBezeichnung,
                        new GridBagConstraints(2, iZeile, 3, 1, 1.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    iZeile++;
    jPanelWorkingOn.add(wlaLosgroesse,
                        new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wnfLosgroesse,
                        new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wlaEinheit,
                        new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    iZeile++;
    jPanelWorkingOn.add(wlaProduktionsbeginn,
                        new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wdfProduktionsbeginn,
                        new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wlaDauer,
                        new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
                                               ...
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wnfDauer,
                        new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 20, 0));
    jPanelWorkingOn.add(wlaTage,
                        new GridBagConstraints(4, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    iZeile++;
    jPanelWorkingOn.add(wlaProduktionsende,
                        new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wdfProduktionsende,
                        new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
                                               GridBagConstraints.CENTER,
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
  ...
  private void components2Dto()
    ...
    InternebestellungDto dto = getTabbedPaneInternebestellung().getInternebestellungDto();
    if (dto == null) {
    ...
    if (getTabbedPaneInternebestellung().getStuecklisteDto() != null) {
      dto.setStuecklisteIId(getTabbedPaneInternebestellung().getStuecklisteDto().getIId());
    }
    else {
  ...
  private void dto2Components()
      throws Throwable {
    InternebestellungDto ibDto = getTabbedPaneInternebestellung().getInternebestellungDto();
    ...
    // rueckdatieren
    if (wnfDauer.getInteger() != null) {
      wdfProduktionsbeginn.setDate(Helper.addiereTageZuDatum(ibDto.getTLiefertermin(),
          -wnfDauer.getInteger()));
    }
  ...
  private void dto2ComponentsStueckliste()
      throws Throwable {
    if (getTabbedPaneInternebestellung().getStuecklisteDto() != null) {
      StuecklisteDto stuecklisteDto = getTabbedPaneInternebestellung().getStuecklisteDto();
      wbuStueckliste.setOKey(stuecklisteDto.getIId());
      wtfStuecklisteNummer.setText(stuecklisteDto.getArtikelDto().getCNr());
      ...
      if (stuecklisteDto.getNDefaultdurchlaufzeit() != null) {
        wnfDauer.setInteger(stuecklisteDto.getNDefaultdurchlaufzeit().intValue());
      }
      else {
        // Allgemeine standarddurchlaufzeit
        ParametermandantDto parameter = DelegateFactory.getInstance().
            getParameterDelegate().getMandantparameter(LPMain.getTheClient().getMandant(),
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
    ...
    if (ibDto != null) {
      if (ibDto.getIId() != null) {
        if (!isLockedDlg()) {
          DelegateFactory.getInstance().getFertigungDelegate().removeInternebestellung(
              ibDto);
          getTabbedPaneInternebestellung().setInternebestellungDto(null);
          this.leereAlleFelder(this);
  ...
  private void holeAuftrag(Object key)
    ...
    if (key != null) {
      ...
      // falls die gewaehlte Auftragsposition nicht zu diesem Auftrag gehoert - loeschen
      if (auftragpositionDto != null &&
  ...
  private void holeStueckliste(Object key)
      throws Throwable {
    if (key != null) {
      if (getTabbedPaneInternebestellung().getStuecklisteDto() == null ||
          !getTabbedPaneInternebestellung().getStuecklisteDto().getIId().equals(key)) {
        getTabbedPaneInternebestellung().setStuecklisteDto(DelegateFactory.getInstance().
            getStuecklisteDelegate().stuecklisteFindByPrimaryKey( (Integer) key));
      }
    }
    else {
  ...
  private void dialogQueryStueckliste(ActionEvent e)
    ...
    if (getTabbedPaneInternebestellung().getStuecklisteDto() != null) {
      selectedId = getTabbedPaneInternebestellung().getStuecklisteDto().getIId();
    }
    panelQueryFLRStueckliste = StuecklisteFilterFactory.getInstance().
        createPanelFLRStueckliste(getInternalFrame(), selectedId,false);
    new DialogQuery(panelQueryFLRStueckliste);
  }


  protected void focusLostPI(FocusEvent e)
      throws Throwable {
    if (e.getSource() == wnfDauer ||
      ...
      if (wdfProduktionsbeginn.getDate() != null &&
        ...
        dEnde = Helper.addiereTageZuDatum(wdfProduktionsbeginn.getDate(),
                                          wnfDauer.getInteger().intValue());
        wdfProduktionsende.setMinimumValue(wdfProduktionsbeginn.getDate());
      }
      else {
      ...
      if (wdfProduktionsende.getDate() != null &&
          wnfDauer.getInteger() != null) {
        Date dBeginn = Helper.addiereTageZuDatum(wdfProduktionsende.getDate(), -wnfDauer.getInteger());
        wdfProduktionsbeginn.setMaximumValue(wdfProduktionsende.getDate());
...
class PanelInternebestellung_focusAdapter
