...
public interface ISystemInfoController {
	...
	PingSystemInfo getPingInfo() ;
	
	ServerLocaleInfo getServerLocaleInfo() ;
	
	void setSystemDelegate(SystemDelegate systemDelegate) ;
	
	ServerLocaleInfo getClientLocaleInfo() ;
}
