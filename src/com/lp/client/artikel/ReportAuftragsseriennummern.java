...
public class ReportAuftragsseriennummern extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportAuftragsseriennummern(InternalFrameArtikel internalFrame,
...
wdrBereich = new WrapperDateRangeController(wdfVon, wdfBis);
	...
	public String getReportname() {
		return ArtikelReportFac.REPORT_AUFTRAGSSERIENNUMMERN;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getArtikelReportDelegate()
				.printAuftragsseriennummern(artikelIId,wdfVon.getDate(),wdfBis.getDate());
	}
