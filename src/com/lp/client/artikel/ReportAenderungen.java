...
public class ReportAenderungen
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportAenderungen(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_AENDERUNGEN;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printAenderungen(
        artikelIId);
  }
