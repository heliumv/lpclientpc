...
public class ReportArtikelRahmenbestellungsliste
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportArtikelRahmenbestellungsliste(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_ARTIKELBESTELLTRAHMEN;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printRahmenbestellungsliste(
        artikelIId);
  }
