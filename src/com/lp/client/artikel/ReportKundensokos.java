...
public class ReportKundensokos
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportKundensokos(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_KUNDENSOKOS;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printKundensokos(
        artikelIId);
  }
