...
public class ReportVkpreisentwicklung
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportVkpreisentwicklung(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_VKPREISENTWICKLUNG;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printVkPreisentwicklung(
        artikelIId);
  }
