...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportLosstatus(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printLosstatus(
        artikelIId);
  }
