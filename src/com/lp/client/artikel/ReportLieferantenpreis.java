...
public class ReportLieferantenpreis
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportLieferantenpreis(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_LIEFERANTENPREIS;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printLieferantenpreis(artikelIId);
  }
