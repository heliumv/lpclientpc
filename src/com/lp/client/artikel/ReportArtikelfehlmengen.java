...
public class ReportArtikelfehlmengen
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportArtikelfehlmengen(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_ARTIKELFEHLMENGE;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printFehlmengen(
        artikelIId);
  }
