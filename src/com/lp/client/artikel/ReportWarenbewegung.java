...
public class ReportWarenbewegung
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportWarenbewegung(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  private void jbInit()
	...
	jpaWorkingOn.add(wsfLager, new GridBagConstraints(0, 3, 1, 1, 0,
			0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
			new Insets(2, 2, 2, 2), 0, 0));
    jpaWorkingOn.add(wsfLager.getWrapperTextField(), new GridBagConstraints(2, 3, 1, 1, 0,
			0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
			new Insets(2, 2, 2, 2), 0, 0));
  ...
  public String getReportname() {
    return LagerReportFac.REPORT_WARENBEWEGUNGSJOURNAL;
  }
