...
public class ReportFreiInFertigung
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportFreiInFertigung(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_FREIINFERTIGUNG;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printFreiInFertigung(
        artikelIId);
  }
