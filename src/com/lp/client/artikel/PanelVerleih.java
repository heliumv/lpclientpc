...
//von hier ...
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    verleihDto = new VerleihDto();
  }


  protected void dto2Components()throws Throwable {
    wnfFaktor.setDouble(verleihDto.getFFaktor());
    wnfTage.setInteger(verleihDto.getITage());

  }


  protected void components2Dto()throws Throwable {
    verleihDto.setFFaktor(wnfFaktor.getDouble());
    verleihDto.setITage(wnfTage.getInteger());
  }
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_VERLEIH;
  }
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
    ...
    DelegateFactory.getInstance().getArtikelDelegate().removeVerleih(verleihDto);
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      verleihDto = DelegateFactory.getInstance().getArtikelDelegate().
      verleihFindByPrimaryKey( (Integer) key);
      dto2Components();
    }
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (verleihDto.getIId() == null) {
        ...
        verleihDto.setIId(DelegateFactory.getInstance().getArtikelDelegate().createVerleih(
            verleihDto));
        setKeyWhenDetailPanel(verleihDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getArtikelDelegate().updateVerleih(
            verleihDto);
      }
      super.eventActionSave(e, true);
      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(verleihDto.getIId().
                                              toString());
      }
