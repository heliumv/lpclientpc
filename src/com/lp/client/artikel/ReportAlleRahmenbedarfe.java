...
public class ReportAlleRahmenbedarfe extends PanelBasis implements
		PanelReportIfJRDS {
	...
	public ReportAlleRahmenbedarfe(InternalFrame internalFrame, String add2Title)
			throws Throwable {
	...
	public String getModul() {
		return RahmenbedarfeFac.REPORT_MODUL;
	}
	...
	private void jbInit() throws Exception {
		...
		wlaSortierung.setText(LPMain.getTextRespectUISPr(
				"label.sortierung"));
		wrbSortArtikelnr.setText(LPMain.getTextRespectUISPr(
				"artikel.artikelnummer"));
		wrbSortLieferant.setText(LPMain.getTextRespectUISPr(
				"label.lieferant"));
		...
		jpaWorkingOn.add(wrbSortArtikelnr, new GridBagConstraints(1, iZeile, 1,
	...
	public String getReportname() {
		return RahmenbedarfeFac.REPORT_ALLERAHMENBEDARFE;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getRahmenbedarfeDelegate()
				.printAlleOffenenRahmenbedarfe(wrbSortArtikelnr.isSelected());
	}
