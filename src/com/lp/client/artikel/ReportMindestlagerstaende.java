...
public class ReportMindestlagerstaende extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportMindestlagerstaende(InternalFrameArtikel internalFrame,
	...
	public String getReportname() {
		return ArtikelReportFac.REPORT_MINDESTLAGERSTAENDE;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getArtikelReportDelegate()
				.printMindestlagerstaende();
	}
