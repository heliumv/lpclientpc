...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportLagerplatz(InternalFrameArtikel internalFrame, String add2Title, Integer lagerplatzIId)
      throws Throwable {
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_LAGERPLATZETIKETT;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getArtikelReportDelegate().printLagerplatzetikett(
    		lagerplatzIId);
  }
