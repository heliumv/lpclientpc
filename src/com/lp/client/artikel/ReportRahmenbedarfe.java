...
public class ReportRahmenbedarfe
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportRahmenbedarfe(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
    super(internalFrame, add2Title);
    LPMain.getInstance().getTextRespectUISPr("artikel.report.rahmendetailbedarf");
    jbInit();
    initComponents();
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_LOSSTATUS;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getRahmenbedarfeDelegate().printRahmenbedarfe(
        artikelIId);
  }
