...
/**
 * <p><I>Dialog zur Eingabe der Kriterien fuer die Lieferschein Uebersicht.</I> </p>
 ...
 */
public class PanelDialogKriterienLieferscheinUebersicht
...
/** Cache for convenience. */
  ...
  private WrapperNumberField wnfGeschaeftsjahr = null;

  public PanelDialogKriterienLieferscheinUebersicht(InternalFrame oInternalFrameI,
                                               String title) throws
      Throwable {
  ...
  private void jbInit() throws Throwable {
    ...
    wnfGeschaeftsjahr = new WrapperNumberField();
    wnfGeschaeftsjahr.setMandatoryField(true);
    wnfGeschaeftsjahr.setFractionDigits(0);
    wnfGeschaeftsjahr.setMaximumIntegerDigits(4);
    ...
    jpaWorkingOn.add(wlaEmptyLabel3,
                        new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0
                                               ...
                                               GridBagConstraints.BOTH,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jpaWorkingOn.add(wnfGeschaeftsjahr,
  ...
  private void setDefaults() throws Throwable {
    wrbMonat.setSelected(true);
    wnfGeschaeftsjahr.setInteger(new Integer(2005)); // @todo geschaeftsjahr?  PJ 4919
  }
  ...
  public FilterKriterium[] buildFilterKriterien() throws Throwable {
    ...
    FilterKriterium fkGeschaeftsjahr = new FilterKriterium(
          LieferscheinFac.KRIT_JAHRESZAHL,
          true,
          wnfGeschaeftsjahr.getInteger().toString(),
          FilterKriterium.OPERATOR_EQUAL, false);


    aAlleKriterien[LieferscheinFac.IDX_KRIT_ZEITEINHEIT] = fkAuswertung;
    aAlleKriterien[LieferscheinFac.IDX_KRIT_JAHRESZAHL] = fkGeschaeftsjahr;
