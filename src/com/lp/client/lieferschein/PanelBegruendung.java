...
//von hier ...
  ...
  private BegruendungDto begruendungDto = null;
  private WrapperLabel wlaBezeichnung = new WrapperLabel();
  private WrapperTextField wtfBezeichnung = new WrapperTextField();

  public PanelBegruendung(InternalFrame internalFrame, String add2TitleI,
                                  Object pk)
      throws Throwable {
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    begruendungDto = new BegruendungDto();
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_BEGRUENUNG;
  }
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws Throwable {
    DelegateFactory.getInstance().getLieferscheinServiceDelegate().removeBegruendung(
        begruendungDto.getIId());
  ...
  protected void components2Dto() {
    begruendungDto.setCNr(wtfKennung.getText());
    begruendungDto.setCBez(wtfBezeichnung.
        getText());
  }
  ...
  protected void dto2Components()
      throws Throwable {
    wtfKennung.setText(begruendungDto.getCNr());
    wtfBezeichnung.setText(begruendungDto.getCBez());
  }
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      components2Dto();
      if (begruendungDto.getIId() == null) {
        begruendungDto.setIId(DelegateFactory.getInstance().getLieferscheinServiceDelegate().
                                      createBegruendung(begruendungDto));
        setKeyWhenDetailPanel(begruendungDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getLieferscheinServiceDelegate().updateBegruendung(
            begruendungDto);
      }
      super.eventActionSave(e, true);
      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(begruendungDto.getIId() + "");
      }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      begruendungDto = DelegateFactory.getInstance().getLieferscheinServiceDelegate().
          begruendungFindByPrimaryKey( (Integer) key);
      dto2Components();
    }
  }
}
