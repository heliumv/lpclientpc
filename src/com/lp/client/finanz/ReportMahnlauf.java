...
/**
 * <p> Diese Klasse kuemmert sich um den Druck eines Mahnlaufs</p>
 *
 * <p>Copyright Logistik Pur Software GmbH (c) 2004-2008</p>
 *
 * <p>Erstellung: Martin Bluehweis; 29.12.05</p>
 *
 * <p>@author $Author: sebastian $</p>
 *
 * @version not attributable Date $Date: 2009/08/25 13:19:53 $
 */
public class ReportMahnlauf
...
private Integer mahnlaufIId = null;
  ...
  public ReportMahnlauf(InternalFrame internalFrame, Integer mahnlaufIId,
                        String sAdd2Title)
      throws Throwable {
    ...
    wcbSortiereNachKostenstelle.setVisible(false);
    wrbKostenstelleEine.setVisible(false);
  }
  ...
  public String getReportname() {
    return FinanzReportFac.REPORT_MAHNLAUF;
  }
  ...
  public JasperPrintLP getReport(String sDrucktype)
    ...
    return DelegateFactory.getInstance().getFinanzReportDelegate().printMahnlauf(krit,
        mahnlaufIId);
  }
