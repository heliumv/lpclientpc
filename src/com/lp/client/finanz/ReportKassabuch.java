...
public class ReportKassabuch extends ReportKontoblaetter {
	...
	public ReportKassabuch(InternalFrameFinanz internalFrame,
			KontoDto theKontoDto, String sAdd2Title) throws Throwable {
		super(internalFrame, theKontoDto, sAdd2Title) ;
	}
