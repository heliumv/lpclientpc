...
public class ReportMitarbeiterreklamation extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportMitarbeiterreklamation(InternalFrame internalFrame, String add2Title)
			throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		jpaWorkingOn.add(wcbLieferant, new GridBagConstraints(1, iZeile, 1, 1,
				...
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wcbLos, new GridBagConstraints(2, iZeile, 1, 1, 0.1,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(2, 2, 2, 2), 0, 0));
	...
	public String getReportname() {
		return ReklamationReportFac.REPORT_MITARBEITERREKLAMATION;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
			return DelegateFactory
				...
				.printMitarbeiterreklamation(wdfDatumVon.getTimestamp(),
