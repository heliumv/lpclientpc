...
public class PanelAufnahmeart extends PanelBasis {
	...
	private AufnahmeartDto aufnahmeartDto = null;

	public PanelAufnahmeart(InternalFrame internalFrame, String add2TitleI,
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI,
		...
		aufnahmeartDto = new AufnahmeartDto();
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getReklamationDelegate()
				.removeAufnahmeart(aufnahmeartDto);
		this.setKeyWhenDetailPanel(null);
		super.eventActionDelete(e, false, false);
	}

	protected void components2Dto() {
		aufnahmeartDto.setCBez(wtfKennung.getText());

		if (aufnahmeartDto.getAufnahmeartsprDto() == null) {
			aufnahmeartDto.setAufnahmeartsprDto(new AufnahmeartsprDto());
		}
		aufnahmeartDto.getAufnahmeartsprDto().setCBez(wtfBezeichnung.getText());

	}

	protected void dto2Components() {
		wtfKennung.setText(aufnahmeartDto.getCBez());
		if (aufnahmeartDto.getAufnahmeartsprDto() != null) {
			wtfBezeichnung.setText(aufnahmeartDto.getAufnahmeartsprDto()
					.getCBez());
		} else {
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			components2Dto();
			if (aufnahmeartDto.getIId() == null) {
				aufnahmeartDto.setIId(DelegateFactory.getInstance()
						.getReklamationDelegate()
						.createAufnahmeart(aufnahmeartDto));
				setKeyWhenDetailPanel(aufnahmeartDto.getIId());
			} else {
				DelegateFactory.getInstance().getReklamationDelegate()
						.updateAufnahmeart(aufnahmeartDto);
			}
	...
	protected String getLockMeWer() throws Exception {
		return HelperClient.LOCKME_AUFNAHMEART;
	}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null
			...
			aufnahmeartDto = DelegateFactory.getInstance()
					.getReklamationDelegate()
