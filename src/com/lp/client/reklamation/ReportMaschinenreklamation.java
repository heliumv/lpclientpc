...
public class ReportMaschinenreklamation extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportMaschinenreklamation(InternalFrame internalFrame, String add2Title)
			throws Throwable {
	...
	public String getReportname() {
		return ReklamationReportFac.REPORT_MASCHINENREKLAMATION;
	}
