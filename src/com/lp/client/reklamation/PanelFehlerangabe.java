...
public class PanelFehlerangabe extends PanelBasis {
	...
	private FehlerangabeDto fehlerangabeDto = null;

	public PanelFehlerangabe(InternalFrame internalFrame, String add2TitleI,
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI,
		...
		fehlerangabeDto = new FehlerangabeDto();
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getReklamationDelegate()
				.removeFehlerangabe(fehlerangabeDto);
	...
	protected void components2Dto() {
		...
		fehlerangabeDto.setCBez(wtfKennung.getText());

		if (fehlerangabeDto.getFehlerangabesprDto() == null) {
			fehlerangabeDto.setFehlerangabesprDto(new FehlerangabesprDto());
		}
		fehlerangabeDto.getFehlerangabesprDto().setCBez(
				wtfBezeichnung.getText());

	}

	protected void dto2Components() {
		wtfKennung.setText(fehlerangabeDto.getCBez());
		if (fehlerangabeDto.getFehlerangabesprDto() != null) {
			wtfBezeichnung.setText(fehlerangabeDto.getFehlerangabesprDto()
					.getCBez());
		} else {
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (fehlerangabeDto.getIId() == null) {
				fehlerangabeDto.setIId(DelegateFactory.getInstance()
						.getReklamationDelegate()
						.createFehlerangabe(fehlerangabeDto));
				setKeyWhenDetailPanel(fehlerangabeDto.getIId());
			} else {
				DelegateFactory.getInstance().getReklamationDelegate()
						.updateFehlerangabe(fehlerangabeDto);
			}
	...
	protected String getLockMeWer() throws Exception {
		return HelperClient.LOCKME_FEHLERANGABE;
	}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null
			...
			fehlerangabeDto = DelegateFactory.getInstance()
					.getReklamationDelegate()
