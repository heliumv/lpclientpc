...
public class PanelFehler extends PanelBasis {
	...
	private FehlerDto fehlerDto = null;

	public PanelFehler(InternalFrame internalFrame, String add2TitleI, Object pk)
			throws Throwable {
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getReklamationDelegate()
				.removeFehler(fehlerDto);
		this.setKeyWhenDetailPanel(null);
		super.eventActionDelete(e, false, false);
	}

	protected void components2Dto() {
		fehlerDto.setCBez(wtfKennung.getText());

		if (fehlerDto.getFehlersprDto() == null) {
			fehlerDto.setFehlersprDto(new FehlersprDto());
		}
		fehlerDto.getFehlersprDto().setCBez(wtfBezeichnung.getText());

	}

	protected void dto2Components() {

		wtfKennung.setText(fehlerDto.getCBez());
		if (fehlerDto.getFehlersprDto() != null) {
			wtfBezeichnung.setText(fehlerDto.getFehlersprDto().getCBez());
		} else {
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (fehlerDto.getIId() == null) {
				fehlerDto.setIId(DelegateFactory.getInstance()
						.getReklamationDelegate().createFehler(fehlerDto));
				setKeyWhenDetailPanel(fehlerDto.getIId());
			} else {
				DelegateFactory.getInstance().getReklamationDelegate()
						.updateFehler(fehlerDto);
			}
			super.eventActionSave(e, true);

			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame().setKeyWasForLockMe(fehlerDto.getIId() + "");
			}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null
			...
			fehlerDto = DelegateFactory.getInstance().getReklamationDelegate()
