...
public class PanelMassnahme extends PanelBasis {
	...
	private MassnahmeDto massnahmeDto = null;

	public PanelMassnahme(InternalFrame internalFrame, String add2TitleI,
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getReklamationDelegate()
				.removeMassnahme(massnahmeDto);
		this.setKeyWhenDetailPanel(null);
		super.eventActionDelete(e, false, false);
	}

	protected void components2Dto() {
		massnahmeDto.setCBez(wtfKennung.getText());

		if (massnahmeDto.getMassnahmesprDto() == null) {
			massnahmeDto.setMassnahmesprDto(new MassnahmesprDto());
		}
		massnahmeDto.getMassnahmesprDto().setCBez(wtfBezeichnung.getText());
	}

	protected void dto2Components() {
		wtfKennung.setText(massnahmeDto.getCBez());
		if (massnahmeDto.getMassnahmesprDto() != null) {
			wtfBezeichnung.setText(massnahmeDto.getMassnahmesprDto().getCBez());
		} else {
			...
			if (massnahmeDto.getIId() == null) {
				massnahmeDto
						.setIId(DelegateFactory.getInstance()
								...
								.createMassnahme(massnahmeDto));
				setKeyWhenDetailPanel(massnahmeDto.getIId());
			} else {
				DelegateFactory.getInstance().getReklamationDelegate()
						.updateMassnahme(massnahmeDto);
			}
	...
	protected String getLockMeWer() throws Exception {
		return HelperClient.LOCKME_MASSNAHME;
	}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null
			...
			massnahmeDto = DelegateFactory.getInstance()
					.getReklamationDelegate()
