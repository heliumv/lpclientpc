...
//von hier ...
  ...
  private TermintreueDto schwereDto = null;
  ...
  public PanelTermintreue(InternalFrame internalFrame, String add2TitleI,
                                  Object pk)
      throws Throwable {
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws Throwable {
    DelegateFactory.getInstance().getReklamationDelegate().removeTermintreue(
        schwereDto);
  ...
  protected void components2Dto() throws Throwable {
    schwereDto.setITage(wnfTage.getInteger());
  ...
  protected void dto2Components()
      throws Throwable {
	  wnfTage.setInteger(schwereDto.getITage());
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (schwereDto.getIId() == null) {
        schwereDto.setIId(DelegateFactory.getInstance().getReklamationDelegate().
                                      createTermintreue(schwereDto));
        setKeyWhenDetailPanel(schwereDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getReklamationDelegate().updateTermintreue(
            schwereDto);
      }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      schwereDto = DelegateFactory.getInstance().getReklamationDelegate().
          termintreueFindByPrimaryKey( (Integer) key);
      dto2Components();
    }
  }
}
