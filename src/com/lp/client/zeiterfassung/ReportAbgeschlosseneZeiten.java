...
public class ReportAbgeschlosseneZeiten extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportAbgeschlosseneZeiten(InternalFrameZeiterfassung internalFrame,
	...
	private void jbInit() throws Throwable {
		...
		wcbMitVersteckten
				.setText(LPMain
						.getTextRespectUISPr("zeiterfassung.report.abgeschlossenezeitbuchungen.mitversteckten"));
		...
		if (DelegateFactory.getInstance().getTheJudgeDelegate()
			...
			jpaWorkingOn.add(wcbMitVersteckten, new GridBagConstraints(0, 0, 1,
					1, 1.0, 1.0, GridBagConstraints.WEST,
					GridBagConstraints.BOTH, new Insets(0, 110, 0, 0), 0, 0));
		}
	...
	public String getReportname() {
		return ZeiterfassungReportFac.REPORT_ABGESCHLOSSENE_ZEITBUCHUNGEN;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory
				...
				.printAbgeschlosseneZeitbuchungen(
