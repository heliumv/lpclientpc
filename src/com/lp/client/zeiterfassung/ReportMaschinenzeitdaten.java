...
public class ReportMaschinenzeitdaten
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportMaschinenzeitdaten(InternalFrameZeiterfassung internalFrame,
                                      String add2Title)
      throws Throwable {
    ...
    if (internalFrame.getPersonalDto() != null) {
      wtfPersonal.setText(internalFrame.getMaschineDto().getBezeichnung());
  ...
  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getZeiterfassungReportDelegate().printMaschinenzeitdaten(
        maschineIId, wdfVon.getTimestamp(), wdfBis.getTimestamp());
  }
  ...
  private void jbInit()
    ...
    wbuPersonal.setText(LPMain.getInstance().getTextRespectUISPr(
        "zeiterfassung.report.maschinenzeitdaten.selektiertemaschine") + ": ");
    ...
    jpaWorkingOn.add(wlaZeitraum, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
        , GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2),
        0, 0));
    jpaWorkingOn.add(wtfPersonal, new GridBagConstraints(2, 2, 3, 1, 0.0, 0.0
        , GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2),
        0, 0));
    jpaWorkingOn.add(wbuPersonal, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
        , GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2),
        0, 0));
  }
  ...
  public String getReportname() {
    return ZeiterfassungReportFac.REPORT_MASCHINENZEITDATEN;
  }
