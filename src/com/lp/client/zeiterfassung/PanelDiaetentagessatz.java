...
public class PanelDiaetentagessatz extends PanelBasis {
	...
	private WrapperLabel wlaDateinameScript = new WrapperLabel();
	private WrapperTextField wtfDateinameScript = new WrapperTextField();

	private WrapperDateField wdfGueltigab = new WrapperDateField();

	public PanelDiaetentagessatz(InternalFrame internalFrame,
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || (key.equals(LPMain.getLockMeForNew()))) {
			...
			diaetentagessatzDto = DelegateFactory.getInstance()
	...
	protected void dto2Components() throws Throwable {
		...
		wtfDateinameScript.setText(diaetentagessatzDto.getCFilenameScript());
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (diaetentagessatzDto.getIId() == null) {
				diaetentagessatzDto.setDiaetenIId(internalFrameZeiterfassung
						.getDiaetenDto().getIId());
				diaetentagessatzDto.setIId(DelegateFactory.getInstance()
						.getZeiterfassungDelegate()
						.createDiaetentagessatz(diaetentagessatzDto));
				setKeyWhenDetailPanel(diaetentagessatzDto.getIId());
			} else {
				DelegateFactory.getInstance().getZeiterfassungDelegate()
						.updateDiaetentagessatz(diaetentagessatzDto);
			}
			super.eventActionSave(e, true);

			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame().setKeyWasForLockMe(
						internalFrameZeiterfassung.getDiaetenDto().getIId()
								.toString());
			}
...
//		diaetentagessatzDto.setCFilenameScript(wtfDateinameScript.getText());

		if (wtfDateinameScript.isTextForFileNameAllowed()) {
			diaetentagessatzDto.setCFilenameScript(wtfDateinameScript.getText());
		} else {
			DialogFactory.showModalDialog(
					LPMain.getTextRespectUISPr("lp.error"),
					LPMain.getMessageTextRespectUISPr("pers.reisezeiten.script.name.nicht.erlaubt",
							wtfDateinameScript.getText()));
		}
	}
	...
	private void jbInit() throws Throwable {
		...
		wlaStundensatz.setText(LPMain
				.getTextRespectUISPr("pers.personalgehalt.stundensatz"));
		wlaMindestsatz.setText(LPMain
				.getTextRespectUISPr("pers.zeiterfassung.diaeten.mindestsatz"));
		wlaTagessatz.setText(LPMain
				.getTextRespectUISPr("pers.zeiterfassung.diaeten.tagessatz"));

		wlaAbstunden.setText(LPMain
				.getTextRespectUISPr("pers.zeiterfassung.diaeten.abstunden"));

		wcbStundenweise.setText(LPMain
				.getTextRespectUISPr("pers.zeiterfassung.diaeten.stundeweise"));
		wcbStundenweise.addActionListener(this);

		wlaDateinameScript.setText(LPMain
				.getTextRespectUISPr("pers.diaetentagessatz.script"));
		...
		jpaWorkingOn.add(wdfGueltigab, new GridBagConstraints(1, iZeile, 1, 1,
				0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOn.add(wlaTagessatz, new GridBagConstraints(3, iZeile, 1, 1,
				0.05, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wnfTagessatz, new GridBagConstraints(4, iZeile, 1, 1,
				0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOn.add(wlaWaehrung, new GridBagConstraints(5, iZeile, 1, 1,
		...
		jpaWorkingOn.add(wlaStundensatz, new GridBagConstraints(3, iZeile, 1,
				...
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfStundensatz, new GridBagConstraints(4, iZeile, 1,
				1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wlaMindestsatz, new GridBagConstraints(3, iZeile, 1,
				1, 0.05, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfMindestsatz, new GridBagConstraints(4, iZeile, 1,
				1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		iZeile++;
		jpaWorkingOn.add(wcbStundenweise, new GridBagConstraints(1, iZeile, 2,
				1, 0.05, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaAbstunden, new GridBagConstraints(3, iZeile, 1, 1,
				0.05, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfAbstunden, new GridBagConstraints(4, iZeile, 1, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		iZeile++;
		jpaWorkingOn.add(wlaDateinameScript, new GridBagConstraints(0, iZeile,
				1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfDateinameScript, new GridBagConstraints(1, iZeile, 4, 1,
				0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
