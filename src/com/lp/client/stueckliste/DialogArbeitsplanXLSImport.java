...
public class DialogArbeitsplanXLSImport extends JDialog implements
		ActionListener {
	/**
	 * 
	 */
	...
	public DialogArbeitsplanXLSImport(byte[] xlsDatei,
			TabbedPaneStueckliste tpPartner) throws Throwable {
		super(LPMain.getInstance().getDesktop(), "Arbeitsplan XLS importieren",
				true);
	...
	private void jbInit() throws Throwable {
		...
		wlaEinheitZeit.setText(LPMain
				.getTextRespectUISPr("stkl.arbeitplanimport.einheitzeit"));
		...
		panelUrlaubsanspruch.add(wlaEinheitZeit, new GridBagConstraints(0, 2,
				1, 1, 1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		panelUrlaubsanspruch.add(wcbEinheitZeit, new GridBagConstraints(1, 2,
				1, 1, 1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
