...
//von hier ...
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws
      Throwable {
    DelegateFactory.getInstance().getStuecklisteDelegate().removeMontageart(montageartDto);
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (montageartDto.getIId() == null) {
        montageartDto.setCBez(wtfBezeichnung.getText());
        montageartDto.setIId(DelegateFactory.getInstance().getStuecklisteDelegate().
                             createMontageart(montageartDto));
        setKeyWhenDetailPanel(montageartDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getStuecklisteDelegate().updateMontageart(montageartDto);
      }
      super.eventActionSave(e, true);

      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(montageartDto.getIId() + "");
      }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      montageartDto = DelegateFactory.getInstance().getStuecklisteDelegate().
