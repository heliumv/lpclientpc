...
public class ReportStuecklistegesamtkalkulation
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportStuecklistegesamtkalkulation(InternalFrameStueckliste internalFrame,
  ...
  private void jbInit()
    ...
    jpaWorkingOn.add(wlaStueckliste, new GridBagConstraints(0, 0, 1, 1, 1, 0.0
  ...
  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    try {
      JasperPrintLP p = DelegateFactory.getInstance().getStuecklisteReportDelegate().
          printGesamtkalkulation(stuecklisteIId, wnfLosgroesse.getBigDecimal());
      internalFrameStueckliste.getStuecklisteDto().setNLosgroesse(wnfLosgroesse.
          getBigDecimal());
      return p;
    }
    catch (ExceptionLP ex) {
       if (ex.getICode() ==
               com.lp.util.EJBExceptionLP.FEHLER_ZAHL_ZU_KLEIN) {
