...
public class PanelFertigungsgruppe
    extends PanelBasis
{
...
//von hier ...
  ...
  public PanelFertigungsgruppe(InternalFrame internalFrame, String add2TitleI,
                               Object pk)
      throws Throwable {
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws
      Throwable {
    DelegateFactory.getInstance().getStuecklisteDelegate().removeFertigungsgruppe(
        fertigungsgruppeDto);
  ...
  protected void components2Dto()
    ...
    fertigungsgruppeDto.setISort(wnfSortierung.getInteger());
    fertigungsgruppeDto.setIFormularnummer(wtfFormularNr.getInteger());

  }


  protected void dto2Components() {
    wtfBezeichnung.setText(fertigungsgruppeDto.getCBez());
    wnfSortierung.setInteger(fertigungsgruppeDto.getISort());
    wtfFormularNr.setInteger(fertigungsgruppeDto.getIFormularnummer());
  }
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (fertigungsgruppeDto.getIId() == null) {
        fertigungsgruppeDto.setCBez(wtfBezeichnung.getText());
        fertigungsgruppeDto.setIId(DelegateFactory.getInstance().getStuecklisteDelegate().
                                   createFertigungsgruppe(fertigungsgruppeDto));
        setKeyWhenDetailPanel(fertigungsgruppeDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getStuecklisteDelegate().updateFertigungsgruppe(
            fertigungsgruppeDto);
      }
  ...
  private void jbInit()
    ...
    jpaWorkingOn.add(wlaFormularNr,
                     new GridBagConstraints(0, 1, 1, 1, 0, 0.0
                                            , GridBagConstraints.CENTER,
                                            GridBagConstraints.HORIZONTAL,
                                            new Insets(2, 2, 2, 2), 0, 0));
    jpaWorkingOn.add(wtfFormularNr,
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_FERTIGUNGSGRUPPE;
  }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      clearStatusbar();
      wnfSortierung.setInteger(DelegateFactory.getInstance().getStuecklisteDelegate().
                               getNextFertigungsgruppe());
    }
    else {
