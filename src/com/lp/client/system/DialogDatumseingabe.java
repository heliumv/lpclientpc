...
public class DialogDatumseingabe extends JDialog implements
		ActionListener {
	...
	private void jbInit() throws Exception {
		...
		wlaTage.setText(LPMain.getInstance().getTextRespectUISPr("lp.datum"));
