...
public class PanelMwstsatzbez extends PanelBasis {
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || key.equals(LPMain.getLockMeForNew())) {
			...
			mwstsatzbezDto = DelegateFactory.getInstance().getMandantDelegate()
					.mwstsatzbezFindByPrimaryKey((Integer) key);
	...
	private void jbInit() throws Throwable {
		...
		wlaBezeichnung.setText(LPMain
				.getTextRespectUISPr("label.bezeichnung_lang"));
