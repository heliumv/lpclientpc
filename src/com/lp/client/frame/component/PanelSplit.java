...
/**
 *
 * <p> Diese Klasse kuemmert sich ein QP mit einem D-Panel.</p>
 *
 ...
 */
public class PanelSplit
    extends PanelBasis //implements ItemChangedListener UW am 16.9.05 alle raus
{
  /**
	 * 
	 */
...
private PanelBasis panelDetail = null;
  ...
  public PanelSplit(InternalFrame internalFrame,
                    PanelBasis panelDetailI,
                    PanelQuery panelQueryI,
                    int dividerLocationI)
      throws Throwable {
  ...
  private void jbInit()
    ...
    this.add(panelWorkingOn, new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0
    ...
    //panelall.panelworking.panesplit
    panelWorkingOn.add(paneSplit, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0
        , GridBagConstraints.NORTH, GridBagConstraints.BOTH,
        new Insets(0, 0, 0, 0), 0, 0));
  ...
  public void eventActionEscape(ActionEvent e, boolean bNeedNoSaveI)
      throws Throwable {
  ...
  //  panelDetail.eventActionEscape(e, bNeedNoSaveI);
    ...
    /**
     * evtvet: Event "Vetoable Window close"; wird null zurueckgegeben,
 }   * so wird das Modul via dicard beendet, wird ein PropertyVetoException
