...
private PanelQueryFLR panelQuery = null;
  ...
  public DialogQuery(PanelQueryFLR panelQueryI)
    ...
    try {
      ...
      addWindowListener(new java.awt.event.WindowAdapter() {
			public void windowClosing(java.awt.event.WindowEvent e) {
				panelQuery.getInternalFrame().removeItemChangedListener(panelQuery);
      ...
      if (panelQuery.getColumnWidth() > 0) {
        ...
        iHoeheInPixel = new Double(
            Math.sqrt(new Double(iBreiteInPixel).doubleValue())).intValue();
      }
      jbInit();
    }
    catch (Throwable e) {
