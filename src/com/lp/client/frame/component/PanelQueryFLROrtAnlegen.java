...
import com.lp.client.frame.direktanlegen.DialogOrtanlegen;
import com.lp.client.util.fastlanereader.gui.QueryType;
import com.lp.server.util.fastlanereader.service.query.FilterKriterium;
import com.lp.server.util.fastlanereader.service.query.QueryParameters;

public class PanelQueryFLROrtAnlegen
...
public PanelQueryFLROrtAnlegen(QueryType[] typesI,
                       FilterKriterium[] filtersI,
                       String[] aWhichButtonIUseI,
                       InternalFrame internalFrameI,
                       String add2TitleI)
      throws Throwable {
    super(typesI, filtersI, QueryParameters.UC_ID_LANDPLZORT, aWhichButtonIUseI, internalFrameI, add2TitleI);
  }
  ...
  public void eventActionNew(EventObject eventObject,
                             ...
                             boolean bNeedNoNewI)
      throws Throwable {
      DialogOrtanlegen d = new DialogOrtanlegen(getInternalFrame());
      d.setModal(true);
      ...
      if (d.getNeueLandPLzOrtIId() != null) {
    	this.setKeyWhenDetailPanel(d.getNeueLandPLzOrtIId());
