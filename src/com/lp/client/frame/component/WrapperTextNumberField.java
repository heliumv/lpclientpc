...
public class WrapperTextNumberField extends JTextField implements IControl,
	...
	public void setText(String text) {
		...
		if (text != null) {
			if (!text.startsWith("wrapperTextNumberField")) {
				super.setText(text);
			}
		} else {
			super.setText("");
	...
	protected void focusLost() throws ExceptionLP {
		if (getText() != null) {
			if (this.minimumValue != null) {
				if (this.getInteger().intValue() < this.minimumValue.intValue()) {
					Toolkit.getDefaultToolkit().beep();
					this.setInteger(null);
				}
			}
			if (getText() != null && this.maximumValue != null) {
				if (this.getInteger().intValue() > this.maximumValue.intValue()) {
					Toolkit.getDefaultToolkit().beep();
					this.setInteger(null);
				}
			}
...
//	private boolean wholeTextIsSelected() {
...
//	}
	...
	public void setDependenceField(boolean dependenceField) {
		...
		if (dependenceField) {
			...
			this.setBackground(new WrapperTextNumberField().getBackground());
		}
	}
