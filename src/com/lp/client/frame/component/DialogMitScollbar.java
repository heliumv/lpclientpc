...
public class DialogMitScollbar extends JDialog implements ActionListener {
	/**
	 * 
	 */
	...
	JButton wbuOK = new JButton();

	private String message = null;

	private JScrollPane jspScrollPane = new JScrollPane();
	private WrapperTextArea wtaFehler = new WrapperTextArea();
	private boolean bEnableScrollPane =false;

	public DialogMitScollbar(String title,String message, boolean bEnableScrollPane) throws Throwable {
		...
		this.bEnableScrollPane=bEnableScrollPane;
	...
	public WrapperTextArea getWtaFehler() {
		return wtaFehler;
	}
	...
	private void jbInit() throws Throwable {
		...
		wtaFehler.setText(message);
		wtaFehler.setEnabled(bEnableScrollPane);
		...
		panelUrlaubsanspruch.add(wbuOK, new GridBagConstraints(0, 1, 2, 1, 0.0,
