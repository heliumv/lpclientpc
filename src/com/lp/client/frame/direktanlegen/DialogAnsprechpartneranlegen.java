...
public class DialogAnsprechpartneranlegen
    extends JDialog
{
...
private PanelBasis panelDetailFehlmengen = null;
  ...
  public DialogAnsprechpartneranlegen() {
    // nothing here
  }


  public DialogAnsprechpartneranlegen(InternalFrame internalFrame, Integer partnerIId)
      throws Throwable {
    super(LPMain.getInstance().getDesktop(),LPMain.getInstance().getTextRespectUISPr(
                "lp.neueransprechpartneranlegen"), true);
  ...
  public Integer getNeueAnsprechpartnerIId(){
  ...
  private void jbInit()
    ...
    panelDetailFehlmengen =
        new PanelAnsprechpartnerFuerPanelQueryFLR(
            internalFrame,
            LPMain.getInstance().getTextRespectUISPr(
                "lp.neueransprechpartneranlegen"),partnerIId,this);
