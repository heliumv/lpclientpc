...
private PanelBasis panelDetailFehlmengen = null;
  ...
  public DialogOrtanlegen() {
    // nothing here
  }


  public DialogOrtanlegen(InternalFrame internalFrame)
      throws Throwable {
    super(LPMain.getInstance().getDesktop(),LPMain.getInstance().getTextRespectUISPr(
                "lp.neuenortanlegen"), true);
  ...
  private void jbInit()
    ...
    panelDetailFehlmengen =
        new PanelLandPlzOrtFuerPanelQueryFLR(
            internalFrame,
