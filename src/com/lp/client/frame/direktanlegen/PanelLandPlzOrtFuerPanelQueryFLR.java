 ...
 */
public class PanelLandPlzOrtFuerPanelQueryFLR
    extends PanelBasis
{
  /**
	 * 
...
private LandplzortDto landplzortDto = null;
  ...
  public PanelLandPlzOrtFuerPanelQueryFLR(InternalFrame internalFrame, String add2TitleI,
                                          JDialog owner)
      throws Throwable {
  ...
  protected void eventActionSpecial(ActionEvent e)
    ...
    if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_ORT)) {
      ...
      panelQueryFLROrt = new PanelQueryFLR(
          querytypes,
          filters,
          QueryParameters.UC_ID_ORT,
          aWhichButtonIUse,
          getInternalFrame(),
          LPMain.getInstance().getTextRespectUISPr("menueentry.ort"));
    ...
    //neue Tabelle
      ...
      panelQueryFLRLand = new PanelQueryFLR(
          ...
          aWhichButtonIUse,
          getInternalFrame(),
          LPMain.getInstance().getTextRespectUISPr("menueentry.lkz"));
  ...
  protected void components2Dto()
    ...
    // Damit der Ort auch direkt angelegt werden kann. (passiert dann am Server)
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      components2Dto();
      // create.
      Integer iIdLandPlzOrt = DelegateFactory.getInstance().getSystemDelegate().
          createLandplzort(landplzortDto);
      // Dto neu laden
      landplzortDto = DelegateFactory.getInstance().getSystemDelegate().
          landplzortFindByPrimaryKey(iIdLandPlzOrt);
  ...
  protected void eventItemchanged(EventObject eI)
    ...
    if (e.getID() == ItemChangedEvent.GOTO_DETAIL_PANEL) {
      if (e.getSource() == panelQueryFLROrt) {
        Integer iIdOrt = (Integer) ( (ISourceEvent) e.getSource()).getIdSelected();
        //hier wird die Ort id gesetzt
        ortDto = DelegateFactory.getInstance().getSystemDelegate().ortFindByPrimaryKey(
            iIdOrt);
        // Anzeigen
        ...
        // Land holen
        landDto = DelegateFactory.getInstance().getSystemDelegate().landFindByPrimaryKey(
            iId);
        // Anzeigen
  ...
  private void jbInit()
    ...
    add(jPanelWorkingOn,
        new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.SOUTHEAST,
                               GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

    jPanelWorkingOn.add(wlaPLZ,
                        new GridBagConstraints(0, 1, 1, 1, 0.1, 0.0
                                               , GridBagConstraints.CENTER,
                                               GridBagConstraints.HORIZONTAL,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wtfPLZ,
                        new GridBagConstraints(1, 1, 1, 1, 0.1, 0.0
                                               , GridBagConstraints.CENTER,
                                               GridBagConstraints.HORIZONTAL,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wbuLKZ,
                        new GridBagConstraints(0, 0, 1, 1, 0.1, 0.0
                                               , GridBagConstraints.CENTER,
                                               GridBagConstraints.HORIZONTAL,
                                               new Insets(2, 2, 2, 2), 0, 0));
    jPanelWorkingOn.add(wtfLKZ,
                        new GridBagConstraints(1, 0, 1, 1, 0.1, 0.0
                                               , GridBagConstraints.CENTER,
                                               GridBagConstraints.HORIZONTAL,
                                               new Insets(2, 2, 2, 2), 0, 0));

    jPanelWorkingOn.add(wtfLand,
                        new GridBagConstraints(2, 0, 1, 1, 0.1, 0.0
                                               , GridBagConstraints.CENTER,
                                               GridBagConstraints.HORIZONTAL,
                                               new Insets(2, 2, 2, 2), 0, 0));

    jPanelWorkingOn.add(wbuOrt,
  ...
  private void setDefaults()
    ...
    if (mandantDto.getPartnerDto().getLandplzortDto() != null) {
      landDto = mandantDto.getPartnerDto().getLandplzortDto().getLandDto();
      wtfLand.setText(landDto.getCName());
      wtfLKZ.setText(landDto.getCLkz());
    }
  }
