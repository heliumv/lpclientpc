...
public class ReportPanelDynamisch
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportPanelDynamisch(InternalFrame internalFrame, String add2Title,
                              String panelCNr, String reportName, String cKey)
      throws Throwable {
  ...
  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getPanelDelegate().printPanel(panelCNr,
        reportName, cKey);
  }
