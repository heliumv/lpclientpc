    ...
    extends Delegate
{
  ...
  public void preiseGemaessKalkulationsart2Updaten(Integer agstklIId) throws ExceptionLP {
		try {
			angebotstklpositionFac
					.preiseGemaessKalkulationsart2Updaten(agstklIId, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
