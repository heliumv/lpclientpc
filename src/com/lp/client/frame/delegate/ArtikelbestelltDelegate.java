    ...
    extends Delegate
{
  ...
  private ArtikelbestelltFac artikelbestelltFac;
  ...
  public BigDecimal getAnzahlBestellt(Integer artikelIId)
      ...
      ExceptionLP  {
    try {
      return artikelbestelltFac.getAnzahlBestellt(artikelIId);
    }
    catch (Throwable ex) {
      handleThrowable(ex);
      return null;
  ...
  public void pruefeBestelltliste()
      throws ExceptionLP {
    try {
      artikelbestelltFac.pruefeBestelltliste(LPMain.getInstance().getTheClient());
    }
    catch (Throwable ex) {
      handleThrowable(ex);
    }
