...
public class PanelIsmaschine extends PanelBasis {
	/**
	 * 
	 */
	...
	private WrapperSelectField wsfAnlage = new WrapperSelectField(
			WrapperSelectField.ANLAGE, getInternalFrame(), false);
	...
	public PanelIsmaschine(InternalFrame internalFrame, String add2TitleI,
	...
	protected void dto2Components() throws Throwable {
		wsfAnlage.setKey(ismaschineDto.getAnlageIId());
	...
	private void jbInit() throws Throwable {
		...
		wsfAnlage.setMandatoryField(true);
		...
		jpaWorkingOn.add(wtfBezeichnung, new GridBagConstraints(1, iZeile, 3,
				...
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wsfAnlage, new GridBagConstraints(0, iZeile, 1, 1,
				0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wsfAnlage.getWrapperTextField(),
	...
	protected void components2Dto() throws Throwable {
		ismaschineDto.setAnlageIId(wsfAnlage.getIKey());
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getInstandhaltungDelegate()
				.removeIsmaschine(ismaschineDto);
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (ismaschineDto.getIId() == null) {
				ismaschineDto.setIId(DelegateFactory.getInstance()
						.getInstandhaltungDelegate().createIsmaschine(ismaschineDto));
				setKeyWhenDetailPanel(ismaschineDto.getIId());

			} else {

				DelegateFactory.getInstance().getInstandhaltungDelegate()
						.updateIsmaschine(ismaschineDto);
