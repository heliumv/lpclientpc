...
public class PanelHalle extends PanelBasis {
	/**
	 * 
	 */
	...
	private WrapperSelectField wsfStandort = new WrapperSelectField(
			WrapperSelectField.STANDORT, getInternalFrame(), false);

	private WrapperLabel wlaBezeichnung = new WrapperLabel();
	private WrapperTextField wtfBezeichnung = new WrapperTextField();

	private HalleDto halleDto = null;

	public InternalFrameInstandhaltung getInternalFrameInstandhaltung() {
		return internalFrameInstandhaltung;
	}

	public PanelHalle(InternalFrame internalFrame, String add2TitleI, Object pk)
			throws Throwable {
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || key.equals(LPMain.getLockMeForNew())) {
			...
			wsfStandort.setKey(null);

		} else {
			halleDto = DelegateFactory.getInstance()
					.getInstandhaltungDelegate()
					.halleFindByPrimaryKey((Integer) key);
	...
	protected void dto2Components() throws Throwable {
		wsfStandort.setKey(halleDto.getStandortIId());
		wtfBezeichnung.setText(halleDto.getCBez());
	}
	...
	private void jbInit() throws Throwable {
		...
		jpaWorkingOn.add(wtfBezeichnung, new GridBagConstraints(1, iZeile, 3,
				...
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wsfStandort, new GridBagConstraints(0, iZeile, 1, 1,
	...
	protected void components2Dto() throws Throwable {
		halleDto.setStandortIId(wsfStandort.getIKey());
		halleDto.setCBez(wtfBezeichnung.getText());
		halleDto.setMandantCNr(LPMain.getTheClient().getMandant());
	}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (halleDto.getIId() == null) {
				halleDto.setIId(DelegateFactory.getInstance()
						.getInstandhaltungDelegate().createHalle(halleDto));
				setKeyWhenDetailPanel(halleDto.getIId());

			} else {

				DelegateFactory.getInstance().getInstandhaltungDelegate()
						.updateHalle(halleDto);
