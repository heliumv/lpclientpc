...
public class PanelAnlage extends PanelBasis {
	/**
	 * 
	 */
	...
	private WrapperSelectField wsfHalle = new WrapperSelectField(
			WrapperSelectField.HALLE, getInternalFrame(), false);

	private WrapperLabel wlaBezeichnung = new WrapperLabel();
	private WrapperTextField wtfBezeichnung = new WrapperTextField();

	private AnlageDto anlageDto = null;

	public InternalFrameInstandhaltung getInternalFrameInstandhaltung() {
		return internalFrameInstandhaltung;
	}

	public PanelAnlage(InternalFrame internalFrame, String add2TitleI, Object pk)
			throws Throwable {
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || key.equals(LPMain.getLockMeForNew())) {
			...
			wsfHalle.setKey(null);

		} else {
			anlageDto = DelegateFactory.getInstance()
					.getInstandhaltungDelegate()
					.anlageFindByPrimaryKey((Integer) key);
	...
	protected void dto2Components() throws Throwable {
		wsfHalle.setKey(anlageDto.getHalleIId());
		wtfBezeichnung.setText(anlageDto.getCBez());
	}
	...
	private void jbInit() throws Throwable {
		...
		wsfHalle.setMandatoryField(true);
		...
		jpaWorkingOn.add(wtfBezeichnung, new GridBagConstraints(1, iZeile, 3,
				...
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wsfHalle, new GridBagConstraints(0, iZeile, 1, 1,
				0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wsfHalle.getWrapperTextField(),
	...
	protected void components2Dto() throws Throwable {
		anlageDto.setHalleIId(wsfHalle.getIKey());
		anlageDto.setCBez(wtfBezeichnung.getText());
		anlageDto.setMandantCNr(LPMain.getTheClient().getMandant());
	}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (anlageDto.getIId() == null) {
				anlageDto.setIId(DelegateFactory.getInstance()
						.getInstandhaltungDelegate().createAnlage(anlageDto));
				setKeyWhenDetailPanel(anlageDto.getIId());

			} else {

				DelegateFactory.getInstance().getInstandhaltungDelegate()
						.updateAnlage(anlageDto);
