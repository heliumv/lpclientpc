...
public class DialogHalleanlegen extends JDialog {
	...
	private InternalFrameInstandhaltung internalFrame = null;

	public DialogHalleanlegen() {
		// nothing here
	}

	public DialogHalleanlegen(InternalFrameInstandhaltung internalFrame) throws Throwable {
		super(LPMain.getInstance().getDesktop(), LPMain.getInstance()
				.getTextRespectUISPr("is.halle.neuanlegen"), true);
	...
	private void jbInit() throws Throwable {
		...
		panelDetailFehlmengen = new PanelHalleFuerPanelQueryFLR(internalFrame,
				LPMain.getInstance().getTextRespectUISPr("is.halle"), this);
