...
public class DialogAnlageanlegen extends JDialog {
	...
	public DialogAnlageanlegen() {
		// nothing here
	}

	public DialogAnlageanlegen(InternalFrame internalFrame, Integer halleIId) throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		panelDetailFehlmengen = new PanelAnlageFuerPanelQueryFLR(internalFrame,
				LPMain.getInstance().getTextRespectUISPr("is.anlage"), this,halleIId);
