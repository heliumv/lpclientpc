...
public class PanelQueryFLRHalleAnlegen
...
public PanelQueryFLRHalleAnlegen(QueryType[] typesI,
                       FilterKriterium[] filtersI,
                       String[] aWhichButtonIUseI,
                       InternalFrameInstandhaltung internalFrameI,
                       String add2TitleI)
      throws Throwable {
    super(typesI, filtersI, QueryParameters.UC_ID_HALLE, aWhichButtonIUseI, internalFrameI, add2TitleI);
...
InternalFrameInstandhaltung internalFrame=null;
  ...
  public void eventActionNew(EventObject eventObject,
                             ...
                             boolean bNeedNoNewI)
      throws Throwable {
	  DialogHalleanlegen d = new DialogHalleanlegen(internalFrame);
      d.setModal(true);
