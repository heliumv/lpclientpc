...
public class PanelGewerk extends PanelBasis {
	/**
	 * 
	 */
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || key.equals(LPMain.getLockMeForNew())) {
			...
			gewerkDto = DelegateFactory.getInstance()
					.getInstandhaltungDelegate()
					.gewerkFindByPrimaryKey((Integer) key);
	...
	protected void dto2Components() throws Throwable {
		...
		wtfBezeichnung.setText(gewerkDto.getCBez());
	}
	...
	protected void components2Dto() throws Throwable {
		gewerkDto.setCBez(wtfBezeichnung.getText());
		gewerkDto.setMandantCNr(LPMain.getTheClient().getMandant());
	}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (gewerkDto.getIId() == null) {
				gewerkDto.setIId(DelegateFactory.getInstance()
						.getInstandhaltungDelegate()
						.createGewerk(gewerkDto));
				setKeyWhenDetailPanel(gewerkDto.getIId());

			} else {

				DelegateFactory.getInstance().getInstandhaltungDelegate()
						.updateGewerk(gewerkDto);
