 ...
 */
public class PanelAnlageFuerPanelQueryFLR extends PanelBasis {
	/**
	 * 
	 */
	...
	public PanelAnlageFuerPanelQueryFLR(
			InternalFrame internalFrame, String add2TitleI,
			JDialog owner, Integer halleIId) throws Throwable {
	...
	protected void components2Dto() throws Throwable {
		...
		anlageDto.setHalleIId(halleIId);
	...
	public void setAnlageDto(AnlageDto anlageDto) {
		this.anlageDto = anlageDto;
	}
