 ...
 */
public class PanelHalleFuerPanelQueryFLR extends PanelBasis {
	/**
	 * 
	 */
	...
	public PanelHalleFuerPanelQueryFLR(
			InternalFrameInstandhaltung internalFrame, String add2TitleI,
			JDialog owner) throws Throwable {
	...
	protected void components2Dto() throws Throwable {
		...
		halleDto.setStandortIId(internalFrame.getTabbedPaneInstandhaltung().getStandortDto().getIId());
	...
	public void setHalleDto(HalleDto halleDto) {
		this.halleDto = halleDto;
	}
