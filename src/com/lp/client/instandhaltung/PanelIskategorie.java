...
public class PanelIskategorie extends PanelBasis {
	/**
	 * 
	 */
	...
	private IskategorieDto iskategorieDto = null;

	public InternalFrameInstandhaltung getInternalFrameInstandhaltung() {
		return internalFrameInstandhaltung;
	}

	public PanelIskategorie(InternalFrame internalFrame, String add2TitleI,
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || key.equals(LPMain.getLockMeForNew())) {
			...
			iskategorieDto = DelegateFactory.getInstance()
					.getInstandhaltungDelegate()
					.iskategorieFindByPrimaryKey((Integer) key);
	...
	protected void dto2Components() throws Throwable {
		...
		wtfBezeichnung.setText(iskategorieDto.getCBez());
	}
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI,
		...
		iskategorieDto = new IskategorieDto();
	...
	protected void components2Dto() throws Throwable {
		iskategorieDto.setCBez(wtfBezeichnung.getText());
		iskategorieDto.setMandantCNr(LPMain.getTheClient().getMandant());
	}
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getInstandhaltungDelegate()
				.removeIskategorie(iskategorieDto);
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (iskategorieDto.getIId() == null) {
				iskategorieDto.setIId(DelegateFactory.getInstance()
						.getInstandhaltungDelegate()
						.createIskategorie(iskategorieDto));
				setKeyWhenDetailPanel(iskategorieDto.getIId());

			} else {

				DelegateFactory.getInstance().getInstandhaltungDelegate()
						.updateIskategorie(iskategorieDto);
			...
			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame().setKeyWasForLockMe(
						iskategorieDto.getIId().toString());
			}
