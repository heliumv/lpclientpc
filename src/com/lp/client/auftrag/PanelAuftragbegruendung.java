...
public class PanelAuftragbegruendung extends PanelBasis {
	...
	private AuftragbegruendungDto begruendungDto = null;
	private WrapperLabel wlaBezeichnung = new WrapperLabel();
	private WrapperTextField wtfBezeichnung = new WrapperTextField();

	public PanelAuftragbegruendung(InternalFrame internalFrame,
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI,
		...
		begruendungDto = new AuftragbegruendungDto();
	...
	protected String getLockMeWer() throws Exception {
		return HelperClient.LOCKME_AUFTRAGBEGRUENDUNG;
	}
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getAuftragServiceDelegate()
				.removeAuftragbegruendung(begruendungDto.getIId());
	...
	protected void components2Dto() {
		...
		begruendungDto.setCBez(wtfBezeichnung.getText());
	}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			if (begruendungDto.getIId() == null) {
				begruendungDto.setIId(DelegateFactory.getInstance()
						.getAuftragServiceDelegate()
						.createAuftragbegruendung(begruendungDto));
				setKeyWhenDetailPanel(begruendungDto.getIId());
			} else {
				DelegateFactory.getInstance().getAuftragServiceDelegate()
						.updateAuftragbegruendung(begruendungDto);
			}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || (key.equals(LPMain.getLockMeForNew()))) {
			...
			begruendungDto = DelegateFactory.getInstance()
					.getAuftragServiceDelegate()
					.auftragbegruendungFindByPrimaryKey((Integer) key);
			dto2Components();
		}
	}
}
