...
public class ReportAuftragAlle extends PanelReportJournalVerkauf implements
		PanelReportIfJRDS {
	...
	public ReportAuftragAlle(InternalFrame internalFrame, String add2Title)
			throws Throwable {
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getAuftragReportDelegate()
				.printAuftragAlle(getKriterien());
	}

	public String getReportname() {
		return AuftragReportFac.REPORT_AUFTRAG_ALLE;
	}
