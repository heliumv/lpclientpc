 ...
 */
public class ReportAuftragWiederbeschaffung
...
private ButtonGroup buttonGroupSortierung = new ButtonGroup();
  ...
  public JasperPrintLP getReport(String sDrucktype)
    ...
    return DelegateFactory.getInstance().getAuftragReportDelegate().
        printVerfuegbarkeitspruefung(auftragIId, wrbSortLieferant.isSelected());
  }
	...
	private void jbInit() throws Throwable {
		...
		jpaWorkingOn.add(wrbSortAuftragsposition, new GridBagConstraints(1, iZeile, 1,
