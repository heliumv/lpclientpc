...
public class ReportVerfuegbarkeitspruefung extends ReportBeleg {
	...
	public ReportVerfuegbarkeitspruefung(InternalFrame internalFrame, AuftragDto auftragDtoI,
			String add2Title)
			throws Throwable {
		super(internalFrame, null, add2Title, 
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		JasperPrintLP[] aJasperPrint = DelegateFactory.getInstance()
				.getAuftragReportDelegate().printAuftragbestaetigung(
						auftragDto.getIId(), wnfKopien.getInteger(),
		...
		for (int i = 1; i < aJasperPrint.length; i++) {
			jasperPrint = Helper.addReport2Report(jasperPrint, aJasperPrint[i]
					.getPrint());
		}
