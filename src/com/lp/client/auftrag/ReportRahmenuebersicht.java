...
public class ReportRahmenuebersicht extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportRahmenuebersicht(InternalFrame internalFrame,
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		return DelegateFactory.getInstance().getAuftragReportDelegate()
				.printRahmenuebersicht(auftragIId);
	}
