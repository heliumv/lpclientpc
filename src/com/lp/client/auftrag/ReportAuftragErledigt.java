...
public class ReportAuftragErledigt extends PanelReportJournalVerkauf implements
		PanelReportIfJRDS {
	...
	public ReportAuftragErledigt(InternalFrame internalFrame, String add2Title)
			throws Throwable {
	...
	protected void jbInit() throws Exception {
		...
		wbuVertreter = new WrapperButton(LPMain
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getAuftragReportDelegate()
				.printAuftraegeErledigt(getKriterien());
	}

	public String getReportname() {
		return AuftragReportFac.REPORT_AUFTRAG_ERLEDIGT;
	}
