...
/**
 * <p>Report Reservierungsliste fuer Rahmenauftrag.
 * <br>Wird aus dem Artikel heraus aufgerufen.</p>
 * <p>Copyright Logistik Pur Software GmbH (c) 2004-2008</p>
 * <p>Erstellungsdatum 16.11.05</p>
 * <p> </p>
 * @author Uli Walch
 * @version $Revision: 1.4 $
 */
public class ReportRahmenauftragReservierungsliste
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportRahmenauftragReservierungsliste(InternalFrameArtikel internalFrame,
                                String add2Title)
      throws Throwable {
    ...
    if (((InternalFrameArtikel) getInternalFrame()).getArtikelDto() != null) {
  ...
  private void jbInit()
    ...
    wlaArtikel = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr(
  ...
  public String getReportname() {
    return ArtikelReportFac.REPORT_RAHMENRESERVIERUNG;
  }
  ...
  public JasperPrintLP getReport(String sDrucktype)
    ...
    return DelegateFactory.getInstance().getArtikelReportDelegate().printRahmenreservierungsliste(kritDto);
  }
