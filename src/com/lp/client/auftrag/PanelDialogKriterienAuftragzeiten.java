...
/**
 * <p><I>Dialog zur Eingabe der Kriterien fuer die Anzeige der Auftragzeiten.</I> </p>
 * <p>Copyright Logistik Pur Software GmbH (c) 2004-2008</p>
 * <p>Erstellungsdatum <I>18. 04. 2005</I></p>
 * <p> </p>
 * @author Uli Walch
 * @version $Revision: 1.3 $
 */
public class PanelDialogKriterienAuftragzeiten
...
/** Cache for convenience. */
  ...
  public PanelDialogKriterienAuftragzeiten(InternalFrame oInternalFrameI,
                                               String title) throws
      Throwable {
  ...
  private void jbInit() throws Throwable {
    ...
    wlaNach.setMaximumSize(new Dimension(120, Defaults.getInstance().getControlHeight()));
    wlaNach.setMinimumSize(new Dimension(120, Defaults.getInstance().getControlHeight()));
    wlaNach.setPreferredSize(new Dimension(120, Defaults.getInstance().getControlHeight()));
  ...
  public FilterKriterium[] buildFilterKriterien() throws Throwable {
    aAlleKriterien = new FilterKriterium[AuftragFac.ANZAHL_KRITERIEN_AUFTRAGZEITEN];
    ...
    FilterKriterium fkAuftrag = new FilterKriterium(
          AuftragFac.KRIT_AUFTRAG_I_ID,
          true,
          tpAuftrag.getAuftragDto().getIId().toString(),
          FilterKriterium.OPERATOR_EQUAL, false);

    aAlleKriterien[AuftragFac.IDX_KRIT_AUSWERTUNG] = fkAuswertung;
    aAlleKriterien[AuftragFac.IDX_KRIT_AUFTRAG] = fkAuftrag;
