...
public class ReportAuftragOffene2
...
/**
  ...
  protected void jbInit()
    ...
    hm.put(1,LPMain.getTextRespectUISPr("auft.journal.ohnerahmenauftraege")); //ohne Rahmenauftraege, d.h. Abrufe und freie Auftraege
    hm.put(2,LPMain.getTextRespectUISPr("auft.journal.nurrahmenauftraege")); //nur Rahmenauftraege
  ...
  public JasperPrintLP getReport(String sDrucktype)
    ...
    if (wcbMitDetails.isSelected()) {
      return DelegateFactory.getInstance().getAuftragReportDelegate().printAuftragOffene(
          getKriterien(), wdfStichtag.getDate(),
          new Boolean(wcbInternenKommentarDrucken.isSelected()),(Integer) wcoArt.getKeyOfSelectedItem());
    }
    else {
      return DelegateFactory.getInstance().getAuftragReportDelegate().
          printAuftragOffeneOhneDetail(
              getKriterien(), wdfStichtag.getDate(),
              new Boolean(wcbSortiereNachLiefertermin.isSelected()), new Boolean(wcbInternenKommentarDrucken.isSelected())
