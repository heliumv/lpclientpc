...
//von hier ...
  ...
  private LohngruppeDto lohngruppeDto = null;
  public PanelLohngruppe(InternalFrame internalFrame, String add2TitleI,
                         Object pk)
      throws Throwable {
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    lohngruppeDto = new LohngruppeDto();
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws Throwable {
    DelegateFactory.getInstance().getPersonalDelegate().removeLohngruppe(lohngruppeDto.getIId());
  ...
  protected void components2Dto() {
    lohngruppeDto.setCBez(wtfBezeichnung.getText());

  }


  protected void dto2Components() {
    wtfBezeichnung.setText(lohngruppeDto.getCBez());
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      components2Dto();
      if (lohngruppeDto.getIId() == null) {
        lohngruppeDto.setIId(DelegateFactory.getInstance().getPersonalDelegate().createLohngruppe(
            lohngruppeDto));
        setKeyWhenDetailPanel(lohngruppeDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getPersonalDelegate().updateLohngruppe(lohngruppeDto);
      }
      super.eventActionSave(e, true);
      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(lohngruppeDto.getIId() + "");
      }
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_LOHNGRUPPE;
  }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      lohngruppeDto = DelegateFactory.getInstance().getPersonalDelegate().
