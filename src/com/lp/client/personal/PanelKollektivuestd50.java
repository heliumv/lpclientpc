...
public class PanelKollektivuestd50
    extends PanelBasis
{
...
//von hier ...
  ...
  public PanelKollektivuestd50(InternalFrame internalFrame, String add2TitleI,
                             Object pk)
      throws Throwable {
  ...
  protected void components2Dto()
      throws ExceptionLP {
    kollektivuestd50Dto.setKollektivIId(internalFramePersonal.getKollektivDto().getIId());
    kollektivuestd50Dto.setTagesartIId( (Integer) wcoTagesart.getKeyOfSelectedItem());
  ...
  private void jbInit()
    ...
    wcbRestdestages.addActionListener(new
                                      PanelKollektivuestd50_wcbRestdestages_actionAdapter(this));
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      kollektivuestd50Dto = DelegateFactory.getInstance().getPersonalDelegate().
...
class PanelKollektivuestd50_wcbRestdestages_actionAdapter
    implements ActionListener
{
  private PanelKollektivuestd50 adaptee;
  PanelKollektivuestd50_wcbRestdestages_actionAdapter(PanelKollektivuestd50 adaptee) {
