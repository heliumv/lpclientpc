...
public class ReportFahrzeug extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private Integer fahrzeuglIId = null;
	private WrapperDateRangeController wdrBereich = null;

	public ReportFahrzeug(InternalFrame internalFrame,FahrzeugDto fahrzeugDto, String add2Title)
			throws Throwable {
		...
		initComponents();
		if (fahrzeugDto!= null) {
			wtfFahrzeug.setText(fahrzeugDto.getCBez());
			fahrzeuglIId = fahrzeugDto.getIId();
		}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		Integer fahrzeuglIIdLoc = fahrzeuglIId;
		...
		return DelegateFactory
				...
				.printFahrzeuge(fahrzeuglIIdLoc, wdfVon.getTimestamp(),
						wdfBisTemp);
	}
	...
	private void jbInit() throws Throwable {
		...
		wtfFahrzeug.setEditable(false);
		wtfFahrzeug.setSaveReportInformation(false);
		...
		jpaWorkingOn.add(wtfFahrzeug, new GridBagConstraints(2, 2, 3, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(2, 2, 2, 2), 0, 0));
