...
public class PanelPersonalgruppekosten
    extends PanelBasis
{
...
//von hier ...
  ...
  private PersonalgruppekostenDto personalgruppekostenDto = null;
  ...
  public PanelPersonalgruppekosten(InternalFrame internalFrame, String add2TitleI,
                              Object pk)
      throws Throwable {
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      personalgruppekostenDto = DelegateFactory.getInstance().getPersonalDelegate().
          personalgruppekostenFindByPrimaryKey( (Integer) key);
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    leereAlleFelder(this);
    personalgruppekostenDto = new PersonalgruppekostenDto();
  ...
  protected void dto2Components()
      throws Throwable {
    wnfStundensatz.setBigDecimal(personalgruppekostenDto.getNStundensatz());
    wdfGueltigab.setTimestamp(personalgruppekostenDto.getTGueltigab());
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (personalgruppekostenDto.getIId() == null) {
        personalgruppekostenDto.setPersonalgruppeIId(internalFramePersonal.getTabbedPanePersonalgruppe().
                                          personalgruppeDto.getIId());
        personalgruppekostenDto.setIId(DelegateFactory.getInstance().getPersonalDelegate().
                                  createPersonalgruppekosten(
                                      personalgruppekostenDto));
        setKeyWhenDetailPanel(personalgruppekostenDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getPersonalDelegate().updatePersonalgruppekosten(
            personalgruppekostenDto);
      }
      super.eventActionSave(e, true);

      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(internalFramePersonal.getTabbedPanePersonalgruppe().
                personalgruppeDto.getIId().
                                              toString());
      }
  ...
  protected void components2Dto()
      throws ExceptionLP {
    personalgruppekostenDto.setNStundensatz(wnfStundensatz.getBigDecimal());
    personalgruppekostenDto.setTGueltigab(wdfGueltigab.getTimestamp());
  }
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws Throwable {
    DelegateFactory.getInstance().getPersonalDelegate().removePersonalgruppekosten(personalgruppekostenDto);
