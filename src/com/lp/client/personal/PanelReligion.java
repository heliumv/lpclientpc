...
//von hier ...
  ...
  private ReligionDto religionDto = null;
  private WrapperLabel wlaBezeichnung = new WrapperLabel();
  private WrapperTextField wtfBezeichnung = new WrapperTextField();
  public PanelReligion(InternalFrame internalFrame, String add2TitleI,
                       Object pk)
      throws Throwable {
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws
      Throwable {
    DelegateFactory.getInstance().getPersonalDelegate().removeReligion(religionDto);
  ...
  protected void components2Dto() {
    religionDto.setCNr(wtfKennung.getText());
    if (religionDto.getReligionsprDto() == null) {
      religionDto.setReligionsprDto(new ReligionsprDto());
    }
    religionDto.getReligionsprDto().setCBez(wtfBezeichnung.
                                            getText());
  ...
  protected void dto2Components() {
    wtfKennung.setText(religionDto.getCNr());
    if (religionDto.getReligionsprDto() != null) {
      wtfBezeichnung.setText(religionDto.getReligionsprDto().getCBez());
    }
    else {
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (religionDto.getIId() == null) {
        religionDto.setIId(DelegateFactory.getInstance().getPersonalDelegate().createReligion(
            religionDto));
        setKeyWhenDetailPanel(religionDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getPersonalDelegate().updateReligion(religionDto);
      }
      super.eventActionSave(e, true);

      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(religionDto.getCNr());
      }
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_RELIGION;
  }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      religionDto = DelegateFactory.getInstance().getPersonalDelegate().
