...
public class PanelPendlerpauschale
    extends PanelBasis
{
...
//von hier ...
  ...
  private PendlerpauschaleDto pendlerpauschaleDto = null;
  public PanelPendlerpauschale(InternalFrame internalFrame, String add2TitleI,
                               Object pk)
      throws Throwable {
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    pendlerpauschaleDto = new PendlerpauschaleDto();
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws Throwable {
    DelegateFactory.getInstance().getPersonalDelegate().removePendlerpauschale(
        pendlerpauschaleDto.getIId());
  ...
  protected void components2Dto() {
    pendlerpauschaleDto.setCBez(wtfBezeichnung.getText());

  }


  protected void dto2Components() {
    wtfBezeichnung.setText(pendlerpauschaleDto.getCBez());
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (pendlerpauschaleDto.getIId() == null) {
        pendlerpauschaleDto.setIId(DelegateFactory.getInstance().getPersonalDelegate().
                                   createPendlerpauschale(
                                       pendlerpauschaleDto));
        setKeyWhenDetailPanel(pendlerpauschaleDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getPersonalDelegate().updatePendlerpauschale(
            pendlerpauschaleDto);
      }
      super.eventActionSave(e, true);

      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(pendlerpauschaleDto.getIId() + "");
      }
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_PENDLERPAUSCHALE;
  }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      pendlerpauschaleDto = DelegateFactory.getInstance().getPersonalDelegate().
