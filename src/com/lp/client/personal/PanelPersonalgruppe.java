...
public class PanelPersonalgruppe
    extends PanelBasis
{
...
//von hier ...
  ...
  private PersonalgruppeDto personalgruppeDto = null;
  public PanelPersonalgruppe(InternalFrame internalFrame, String add2TitleI,
                               Object pk)
      throws Throwable {
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    personalgruppeDto = new PersonalgruppeDto();
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws Throwable {
    DelegateFactory.getInstance().getPersonalDelegate().removePersonalgruppe(
        personalgruppeDto);
  ...
  protected void components2Dto() {
    personalgruppeDto.setCBez(wtfBezeichnung.getText());

  }


  protected void dto2Components() {
    wtfBezeichnung.setText(personalgruppeDto.getCBez());
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (personalgruppeDto.getIId() == null) {
        personalgruppeDto.setIId(DelegateFactory.getInstance().getPersonalDelegate().
                                   createPersonalgruppe(
                                       personalgruppeDto));
        setKeyWhenDetailPanel(personalgruppeDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getPersonalDelegate().updatePersonalgruppe(
            personalgruppeDto);
      }
      super.eventActionSave(e, true);

      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(personalgruppeDto.getIId() + "");
      }
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_PERSONALGRUPPE;
  }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      personalgruppeDto = DelegateFactory.getInstance().getPersonalDelegate().
          personalgruppeFindByPrimaryKey( (Integer) key);
