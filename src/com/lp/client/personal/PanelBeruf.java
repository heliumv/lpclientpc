...
//von hier ...
  ...
  private BerufDto berufDto = null;
  public PanelBeruf(InternalFrame internalFrame, String add2TitleI,
                    Object pk)
      throws Throwable {
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws
      Throwable {
    DelegateFactory.getInstance().getPersonalDelegate().removeBeruf(berufDto.getIId());
  ...
  protected void components2Dto() {
    berufDto.setCBez(wtfBezeichnung.getText());

  }


  protected void dto2Components() {
    wtfBezeichnung.setText(berufDto.getCBez());
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      components2Dto();
      if (berufDto.getIId() == null) {
        berufDto.setCBez(wtfBezeichnung.getText());
        berufDto.setIId(DelegateFactory.getInstance().getPersonalDelegate().createBeruf(berufDto));
        setKeyWhenDetailPanel(berufDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getPersonalDelegate().updateBeruf(berufDto);
      }
      super.eventActionSave(e, true);

      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(berufDto.getIId() + "");
      }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      berufDto = DelegateFactory.getInstance().getPersonalDelegate().
