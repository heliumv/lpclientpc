...
public class ReportOffeneInserate extends ReportInseratBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportOffeneInserate(InternalFrame internalFrame, String add2Title)
			throws Throwable {
		super(internalFrame, add2Title,true);
		jbInit();
		setDefaults();
		initComponents();
	}
	...
	public String getReportname() {
		return InseratReportFac.REPORT_INSERATE_OFFENE;
	}
