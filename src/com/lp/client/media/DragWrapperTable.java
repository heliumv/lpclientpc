...
public class DragWrapperTable extends WrapperTable implements ISupportTransferableEmailMeta {
	private static final long serialVersionUID = 3880011936926172091L;
	private TabbedPaneMediaController controller ;
	
	public DragWrapperTable(InternalFrame internalFrame, TableModel dm) {
		super(internalFrame, dm);

		setTransferHandler(new FromTransferHandlerEmailMeta());
		setDragEnabled(true) ;
	}

	public void setController(TabbedPaneMediaController controller) {
	...
	public void dropDone(Transferable data, int action) throws Throwable {
		...
		controller.dropDone(this, data, action) ;
	}
}
