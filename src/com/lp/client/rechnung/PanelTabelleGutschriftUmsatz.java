...
public class PanelTabelleGutschriftUmsatz
   ...
   * @throws Throwable
   */
  public PanelTabelleGutschriftUmsatz(
      int iUsecaseIdI,
  ...
  private void jbInit() throws Exception {
    ...
    TableColumn tcEmpty = getTable().getColumnModel().getColumn(RechnungFac.FLR_SPALTE_GS_UMSATZ_LEER);
  ...
  protected void eventActionRefresh(ActionEvent e, boolean bNeedNoRefreshI) throws
    ...
    wlaKritAuswertung.setText(
        getDefaultFilter()[RechnungFac.IDX_KRIT_JAHR]
