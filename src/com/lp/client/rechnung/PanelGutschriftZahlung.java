...
public class PanelGutschriftZahlung extends PanelRechnungZahlung {
	...
	public PanelGutschriftZahlung(InternalFrame internalFrame, String add2TitleI,
			TabbedPaneRechnungAll tabbedPaneRechnungAll) throws Throwable {
		super(internalFrame, add2TitleI, tabbedPaneRechnungAll) ;
	}

	protected void initCheckboxGutschriftErledigt() {
		wcbErledigtGutschrift.setText(LPMain.getTextRespectUISPr("label.rechnungerledigt"));
	}
