...
public class ReportRechnungAlleProformarechnungen
...
private WrapperCheckBox wcbNurOffene = null;
  ...
  public ReportRechnungAlleProformarechnungen(InternalFrame internalFrame,
                                              String add2Title)
      throws Throwable {
  ...
  private void jbInit() {
    ...
    wcbNurOffene.setText(LPMain.getTextRespectUISPr("lp.nuroffene"));
  ...
  public String getReportname() {
    return RechnungReportFac.REPORT_PROFORMARECHNUNGEN_ALLE;
  }
  ...
  public JasperPrintLP getReport(String sDrucktype)
    ...
    return DelegateFactory.getInstance().getRechnungDelegate().printProformarechnungenAlle(krit);
  }
}
