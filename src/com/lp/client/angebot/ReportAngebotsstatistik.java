 ...
 *
 * @version unbekannt Date $Date: 2009/08/25 13:19:54 $
 */
public class ReportAngebotsstatistik
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportAngebotsstatistik(InternalFrameArtikel internalFrame,
                                 String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return AngebotReportFac.REPORT_ANGEBOTSSTATISTIK;
  }
  ...
  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    ReportAngebotsstatistikKriterienDto kritDto =
        new ReportAngebotsstatistikKriterienDto();
    ...
    return DelegateFactory.getInstance().getAngebotReportDelegate().
        printAngebotsstatistik(kritDto);
