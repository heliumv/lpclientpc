...
public class ReportAngebotAbgelehnte
...
public ReportAngebotAbgelehnte(InternalFrame internalFrame, String add2Title)
      throws Throwable {
  ...
  public String getReportname() {
    return AngebotReportFac.REPORT_ANGEBOT_JOURNAL_ABGELEHNTE;
  }
  ...
  public JasperPrintLP getReport(String sDrucktype)
    ...
    return DelegateFactory.getInstance().getAngebotReportDelegate().
        printAngebotAbgelehnte(kritDto);
  }
