 ...
 */
public class PanelDialogKriterienAngebotzeiten
...
private WrapperLabel wlaNach = null;
  ...
  private TabbedPaneAngebot tabbedPaneAngebot=null;

  public PanelDialogKriterienAngebotzeiten(InternalFrame internalFrame, TabbedPaneAngebot tabbedPaneAngebot, String title) throws
      Throwable {
    super(internalFrame, title);
    this.tabbedPaneAngebot=tabbedPaneAngebot;
    jbInit();
    setDefaults();
    initComponents();
  }
  ...
  public FilterKriterium[] buildFilterKriterien() throws Throwable {
    ...
    FilterKriterium fkAuftrag = new FilterKriterium(
          AngebotFac.KRIT_ANGEBOT_I_ID,
          true,
          tabbedPaneAngebot.getAngebotDto().getIId().toString(),
          FilterKriterium.OPERATOR_EQUAL, false);

    aAlleKriterien[AngebotFac.IDX_KRIT_AUSWERTUNG] = fkAuswertung;
    aAlleKriterien[AngebotFac.IDX_KRIT_ANGEBOT] = fkAuftrag;
