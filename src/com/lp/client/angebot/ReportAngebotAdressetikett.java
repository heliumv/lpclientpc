...
public class ReportAngebotAdressetikett
...
private WrapperButton wbuAnsprechpartner = new WrapperButton();
  ...
  public ReportAngebotAdressetikett(InternalFrame frame,
                                    com.lp.server.partner.service.PartnerDto partnerDto,
                                    Integer ansprechpartnerIIdI,
                                    String add2Title)
      throws Throwable {
  ...
  private void jbInit()
    ...
    jpaWorkingOn.add(wftAnsprechpartner,
                     new GridBagConstraints(1, iZeile, 2, 1, 0.1, 0.0,
                                            GridBagConstraints.CENTER,
                                            GridBagConstraints.HORIZONTAL,
                                            new Insets(2, 2, 2, 2), 0, 0));
    iZeile++;
  ...
  public String getReportname() {
    return AngebotReportFac.REPORT_ANGEBOT_ADRESSETIKETT;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getAngebotReportDelegate().printAdressetikett(partnerIId,
        ansprechpartnerIId);
  }
