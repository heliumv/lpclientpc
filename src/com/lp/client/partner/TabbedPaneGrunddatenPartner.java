 ...
 */
public class TabbedPaneGrunddatenPartner extends TabbedPane {
	/**
	 * 
	 */
	...
	private PanelQuery panelQueryKommentarart = null;
	private PanelBasis panelDetailKommentarart = null;
	private PanelSplit panelSplitKommentarart = null;
	...
	private void jbInit() throws Throwable {
		...
		insertTab(
				LPMain.getInstance().getTextRespectUISPr(
						"part.ansprechpartnerfkt"),
				null,
				null,
				LPMain.getInstance().getTextRespectUISPr(
						"part.ansprechpartnerfkt"), IDX_ANSPRECHPARTNERFKT);

		// Tab 2: Branche
		insertTab(LPMain.getInstance().getTextRespectUISPr("lp.branche"), null,
				null, LPMain.getInstance().getTextRespectUISPr("lp.branche"),
				IDX_PARTNERBRANCHE);

		// Tab 3: Anrede
		insertTab(LPMain.getInstance().getTextRespectUISPr("lp.anrede"), null,
				null, LPMain.getInstance().getTextRespectUISPr("lp.anrede"),
				IDX_ANREDE);
		...
		// Tab 5: Art
		insertTab(LPMain.getInstance().getTextRespectUISPr("lp.art"), null,
				null, LPMain.getInstance().getTextRespectUISPr("lp.art"),
				IDX_PARTNERART);

		// Tab 6: Kommunikationsart
		insertTab(
				LPMain.getInstance()
						.getTextRespectUISPr("lp.kommunikationsart"), null,
				null,
				LPMain.getInstance()
		...
		if (LPMain
			...
			insertTab(
					...
					null,
					LPMain.getInstance().getTextRespectUISPr(
							"proj.projekt.label.kontaktart"), IDX_KONTAKTART);
		}
	...
	public void lPEventItemChanged(ItemChangedEvent eI) throws Throwable {
		...
		if (e.getID() == ItemChangedEvent.ITEM_CHANGED) {
			if (e.getSource() == panelAnsprechpartnerfktQP1) {
				Integer iId = (Integer) panelAnsprechpartnerfktQP1
						.getSelectedId();
			...
			} else if (e.getSource() == panelQueryKommentarart) {
				Integer iId = (Integer) panelQueryKommentarart.getSelectedId();
				getInternalFrame().setKeyWasForLockMe(iId + "");
				panelDetailKommentarart.setKeyWhenDetailPanel(iId);
				panelDetailKommentarart.eventYouAreSelected(false);
				panelQueryKommentarart.updateButtons();
			}
		}
			...
			} else if (e.getSource() == panelDetailKommentarart) {
				panelSplitKommentarart.eventYouAreSelected(false);
			}
		}
			...
			if (eI.getSource() == panelAnsprechpartnerfktBottomD1) {
				...
				panelAnsprechpartnerfktQP1.updateButtons(new LockStateValue(
						PanelBasis.LOCK_FOR_NEW));
			} else if (eI.getSource() == panelBrancheBottomD2) {
				// im QP die Buttons in den Zustand neu setzen.
				panelBrancheQP2.updateButtons(new LockStateValue(
						PanelBasis.LOCK_FOR_NEW));
			} else if (eI.getSource() == panelAnredeBottomD3) {
				// im QP die Buttons in den Zustand neu setzen.
				panelAnredeQP3.updateButtons(new LockStateValue(
						PanelBasis.LOCK_FOR_NEW));
				;
			} else if (eI.getSource() == panelKlasseBottomD4) {
				// im QP die Buttons in den Zustand neu setzen.
				panelKlasseQP4.updateButtons(new LockStateValue(
						PanelBasis.LOCK_FOR_NEW));
				;
			} else if (eI.getSource() == panelPartnerartBottomD5) {
				// im QP die Buttons in den Zustand neu setzen.
				panelPartnerartQP5.updateButtons(new LockStateValue(
						PanelBasis.LOCK_FOR_NEW));
				;
			} else if (eI.getSource() == panelKommunikationsartBottomD6) {
				// im QP die Buttons in den Zustand neu setzen.
				panelKommunikationsartQP6.updateButtons(new LockStateValue(
						PanelBasis.LOCK_FOR_NEW));
				;
				...
				panelQueryKontaktart.updateButtons(new LockStateValue(
						PanelBasis.LOCK_FOR_NEW));
				;
			} else if (eI.getSource() == panelDetailKommentarart) {
				// im QP die Buttons in den Zustand neu setzen.
				panelQueryKommentarart.updateButtons(new LockStateValue(
						PanelBasis.LOCK_FOR_NEW));
				;
			}
		}
			...
			if (e.getSource() == panelAnsprechpartnerfktBottomD1) {
				Object oKey = panelAnsprechpartnerfktBottomD1
				...
				Object oKey = panelKommunikationsartBottomD6
						.getKeyWhenDetailPanel();
				...
				Object oKey = panelDetailKommentarart.getKeyWhenDetailPanel();
				panelQueryKommentarart.eventYouAreSelected(false);
				panelQueryKommentarart.setSelectedId(oKey);
				panelSplitKommentarart.eventYouAreSelected(false);
			}
		}
			...
			if (e.getSource() == panelAnsprechpartnerfktBottomD1) {
				if (panelAnsprechpartnerfktBottomD1.getKeyWhenDetailPanel() == null) {
					Object oNaechster = panelAnsprechpartnerfktQP1
							.getId2SelectAfterDelete();
					panelAnsprechpartnerfktQP1.setSelectedId(oNaechster);
				}
				panelAnsprechpartnerfktSP1.eventYouAreSelected(false); // refresh
																		// auf
																		// das
																		// gesamte
																		// 1:n
				...
				if (panelBrancheBottomD2.getKeyWhenDetailPanel() == null) {
					Object oNaechster = panelBrancheQP2
							.getId2SelectAfterDelete();
					panelBrancheQP2.setSelectedId(oNaechster);
				}
				panelBrancheSP2.eventYouAreSelected(false); // refresh auf das
															// gesamte 1:n panel
			} else if (eI.getSource() == panelAnredeBottomD3) {
				panelAnredeSP3.eventYouAreSelected(false); // refresh auf das
															// gesamte 1:n panel
			} else if (eI.getSource() == panelKlasseBottomD4) {
				if (panelKlasseBottomD4.getKeyWhenDetailPanel() == null) {
					Object oNaechster = panelKlasseQP4
							.getId2SelectAfterDelete();
					panelKlasseQP4.setSelectedId(oNaechster);
				}
				panelKlasseSP4.eventYouAreSelected(false); // refresh auf das
															// gesamte 1:n panel
			} else if (eI.getSource() == panelPartnerartBottomD5) {
				panelPartnerartSP5.eventYouAreSelected(false); // refresh auf
																// das gesamte
																// 1:n panel
			} else if (eI.getSource() == panelKommunikationsartBottomD6) {
				panelKommunikationsartSP6.eventYouAreSelected(false); // refresh
																		// auf
																		// das
																		// gesamte
																		// 1:n
				...
				panelSplitKontaktart.eventYouAreSelected(false); // refresh auf
																	// das
																	// gesamte
																	// 1:n panel
			} else if (eI.getSource() == panelDetailKommentarart) {
				panelSplitKommentarart.eventYouAreSelected(false); // refresh
																	// auf
				// das
				// gesamte
				// 1:n panel
				...
				if (panelSelektionBottomD7.getKeyWhenDetailPanel() == null) {
					Object oNaechster = panelSelektionQP7
							.getId2SelectAfterDelete();
			...
			} else if (eI.getSource() == panelQueryKommentarart) {
				if (panelQueryKommentarart.getSelectedId() == null) {
					getInternalFrame().enableAllPanelsExcept(true);
				}
				panelDetailKommentarart.eventActionNew(eI, true, false);
				panelDetailKommentarart.eventYouAreSelected(false);
				setSelectedComponent(panelSplitKommentarart);
			}
		}
	}
	...
	private void refreshAnsprechpartnerfkt() throws Throwable {

		if (panelAnsprechpartnerfktSP1 == null) {

			// Buttons.
			String[] aButton = { PanelBasis.ACTION_NEW };
			panelAnsprechpartnerfktQP1 = new PanelQuery(null, null,
					QueryParameters.UC_ID_ANSPRECHPARTNERFUNKTION, aButton,
			...
			panelAnsprechpartnerfktBottomD1 = new PanelStammdatenCRUD(
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr("part.ansprechpartnerfkt"),
					null, HelperClient.SCRUD_ANSPRECHPARTNERFKT_FILE,
					(InternalFramePartner) getInternalFrame(),
					HelperClient.LOCKME_ANSPRECHPARTNERFKT);

			panelAnsprechpartnerfktSP1 = new PanelSplit(getInternalFrame(),
					panelAnsprechpartnerfktBottomD1,
					panelAnsprechpartnerfktQP1, 200);
	...
	private void refreshBranche() throws Throwable {

		if (panelBrancheSP2 == null) {

			// Buttons.
			String[] aButton = { PanelBasis.ACTION_NEW };
			panelBrancheQP2 = new PanelQuery(null, null,
					QueryParameters.UC_ID_BRANCHE, aButton, getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.branche"),
					true); // liste refresh wenn lasche geklickt wurde

			panelBrancheBottomD2 = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.branche"),
					null, HelperClient.SCRUD_PARTNERBRANCHE_FILE,
					(InternalFramePartner) getInternalFrame(),
					HelperClient.LOCKME_PARTNERBRANCHE);

			panelBrancheSP2 = new PanelSplit(getInternalFrame(),
					panelBrancheBottomD2, panelBrancheQP2, 200);
	...
	private void refreshKontaktart() throws Throwable {

		if (panelSplitKontaktart == null) {

			// Buttons.
			String[] aButton = { PanelBasis.ACTION_NEW };
			panelQueryKontaktart = new PanelQuery(null, null,
					QueryParameters.UC_ID_KONTAKTART, aButton,
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr(
									"proj.projekt.label.kontaktart"), true); // liste
																				// refresh
																				// wenn
																				// lasche
																				// geklickt
			...
			panelDetailKontaktart = new PanelKontaktart(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr(
							"proj.projekt.label.kontaktart"), null);

			panelSplitKontaktart = new PanelSplit(getInternalFrame(),
					panelDetailKontaktart, panelQueryKontaktart, 300);
	...
	private void refreshKommentarart() throws Throwable {

		if (panelSplitKommentarart == null) {

			// Buttons.
			String[] aButton = { PanelBasis.ACTION_NEW };
			panelQueryKommentarart = new PanelQuery(null, null,
					QueryParameters.UC_ID_PARTNERKOMMENTARART, aButton,
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr("part.kommentarart"), true); // liste
																				// refresh
																				// wenn
																				// lasche
																				// geklickt
			...
			panelDetailKommentarart = new PanelPartnerkommentarart(
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr("part.kommentarart"), null);

			panelSplitKommentarart = new PanelSplit(getInternalFrame(),
					panelDetailKommentarart, panelQueryKommentarart, 300);
			setComponentAt(IDX_KOMMENTARART, panelSplitKommentarart);

			// liste soll sofort angezeigt werden
			panelQueryKommentarart.eventYouAreSelected(true);
		}
	}

	private void refreshAnrede() throws Throwable {

		if (panelAnredeSP3 == null) {

			// Buttons.
			panelAnredeQP3 = new PanelQuery(null, null,
					QueryParameters.UC_ID_ANREDE, null, getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.anrede"), true); // liste
																					// refresh
																					// wenn
																					// lasche
																					// geklickt
			...
			panelAnredeBottomD3 = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.anrede"),
					null, HelperClient.SCRUD_PARTNERANREDE_FILE, this, // Dto
					HelperClient.LOCKME_PARTNERANREDE);

			panelAnredeSP3 = new PanelSplit(getInternalFrame(),
					panelAnredeBottomD3, panelAnredeQP3, 200);
	...
	private void refreshPartnerart() throws Throwable {

		if (panelPartnerartSP5 == null) {
			// Buttons.
			String[] aButton = { PanelBasis.ACTION_NEW };
			panelPartnerartQP5 = new PanelQuery(null, null,
					QueryParameters.UC_ID_PARTNERART, aButton,
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr("lp.art"), true); // liste
																	// refresh
																	// wenn
																	// lasche
																	// geklickt
			...
			panelPartnerartBottomD5 = new PanelStammdatenCRUD(
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr("lp.art"), null,
					HelperClient.SCRUD_PARTNERART_FILE,
					(InternalFramePartner) getInternalFrame(),
					HelperClient.LOCKME_PARTNERART);

			panelPartnerartSP5 = new PanelSplit(getInternalFrame(),
					panelPartnerartBottomD5, panelPartnerartQP5, 200);
	...
	private void refreshKommunikationsart() throws Throwable {

		if (panelKommunikationsartSP6 == null) {
			// Buttons.
			panelKommunikationsartQP6 = new PanelQuery(null, null,
					QueryParameters.UC_ID_KOMMUNIKATIONSART, null,
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr("lp.kommunikationsart"), true); // liste
																					// refresh
																					// wenn
																					// lasche
																					// geklickt
			...
			panelKommunikationsartSP6 = new PanelSplit(getInternalFrame(),
					panelKommunikationsartBottomD6, panelKommunikationsartQP6,
					200);
	...
	private void refreshSelektion() throws Throwable {
		...
		if (panelSelektionSP7 == null) {
			...
			panelSelektionQP7 = new PanelQuery(null, f,
					QueryParameters.UC_ID_SELEKTION, aButton,
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr("lp.selektion"), true); // liste
																			// refresh
																			// wenn
																			// lasche
																			// geklickt
			...
			panelSelektionBottomD7 = new PanelStammdatenCRUD(
					getInternalFrame(), LPMain.getInstance()
							.getTextRespectUISPr("lp.selektion"), null,
					HelperClient.SCRUD_SELEKTION_FILE,
					(InternalFramePartner) getInternalFrame(),
					HelperClient.LOCKME_SELEKTION);

			panelSelektionSP7 = new PanelSplit(getInternalFrame(),
					panelSelektionBottomD7, panelSelektionQP7, 200);
	...
	private void refreshKlasse() throws Throwable {

		if (panelKlasseSP4 == null) {

			// Buttons.
			String[] aButton = { PanelBasis.ACTION_NEW };
			panelKlasseQP4 = new PanelQuery(null, null,
					QueryParameters.UC_ID_PARTNERKLASSE, aButton,
					(InternalFramePartner) getInternalFrame(), LPMain
							.getInstance().getTextRespectUISPr(
									"lp.partnerklasse"), true); // liste refresh
																// wenn lasche
																// geklickt
																// wurde

			panelKlasseBottomD4 = new PanelPartnerklasse(getInternalFrame(),
					LPMain.getInstance()
							.getTextRespectUISPr("lp.partnerklasse"), null);

			panelKlasseSP4 = new PanelSplit(getInternalFrame(),
					panelKlasseBottomD4, panelKlasseQP4, 200);
