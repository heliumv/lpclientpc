 ...
 */
public class PanelKundesokomengenstaffel
...
protected InternalFrameKunde internalFrameKunde = null;
  ...
  public PanelKundesokomengenstaffel(InternalFrame internalFrame, String add2TitleI,
                                     Object key)
      throws Throwable {
  ...
  protected void setDefaults()
    ...
    // den Artikel bzw. die Artikelgruppe bei einer neuen Mengenstaffel initialisieren
    kundesokoDto = internalFrameKunde.getTpKunde().getPanelKundesoko().getKundesokoDto();
    ...
    if (kundesokoDto.getArtikelIId() != null) {
      ...
      panelArtikel.artikelDto2Components(
          panelArtikel.getWifArtikel().getArtikelDto());
      ...
      panelArtgru.artgruDto2components(
          kundesokoDto.getArtgruIId());
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      ...
      if (wcoArt.getKeyOfSelectedItem().equals(ART_ARTIKEL)) {
        ...
        mengenstaffelDto =
            panelArtikel.components2mengenstaffelDto(mengenstaffelDto);
      }
      else { // Artikelgruppe
        mengenstaffelDto =
            panelArtgru.components2mengenstaffelDto(mengenstaffelDto);
      }

      if (mengenstaffelDto.getIId() == null) {
        Integer mengenstaffelIId =
            DelegateFactory.getInstance().getKundesokoDelegate().
            createKundesokomengenstaffel(
                mengenstaffelDto);
        mengenstaffelDto =
            DelegateFactory.getInstance().getKundesokoDelegate().
        ...
        DelegateFactory.getInstance().getKundesokoDelegate().updateKundesokomengenstaffel(
            mengenstaffelDto);
      }
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
    ...
    if (internalFrameKunde.getTpKunde().getPanelKundesokomengenstaffelQP11().getTable().getRowCount() == 1) {
      DialogFactory.showModalDialog(
          LPMain.getInstance().getTextRespectUISPr("lp.hint"),
          LPMain.getInstance().getTextRespectUISPr(
                "part.hint.defaultmengenstaffel"));
    }
    else {
      if (mengenstaffelDto != null && mengenstaffelDto.getIId() != null) {
        DelegateFactory.getInstance().getKundesokoDelegate().removeKundesokomengenstaffel(
            mengenstaffelDto);
      }
...
class PanelKundesokomengenstaffel_wcoArt_actionAdapter
