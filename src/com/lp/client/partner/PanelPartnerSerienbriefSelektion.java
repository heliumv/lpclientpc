 ...
 */
public class PanelPartnerSerienbriefSelektion extends PanelBasis {
	/**
	 * 
	 */
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			components2Dto();
			if (getTabbedPaneSerienbrief().getSerienbriefselektionDto()
					.isIsNew()) {
				// Create.
				SerienbriefselektionPK serienbriefselektionPK = DelegateFactory
						.getInstance()
						.getPartnerServicesDelegate()
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null
			...
			clearStatusbar();
			getTabbedPaneSerienbrief().getSerienbriefselektionDto().setIsNew(
					true);
			...
			// Update.
			FLRSerienbriefselektionPK fLRSerienbriefselektionPK = (FLRSerienbriefselektionPK) key;
			getTabbedPaneSerienbrief().setSerienbriefselektionDto(
					DelegateFactory
							.getInstance()
							.getPartnerServicesDelegate()
							.serienbriefselektionFindByPrimaryKey(
									fLRSerienbriefselektionPK
											.getSerienbrief_i_id(),
									fLRSerienbriefselektionPK
											.getSelektion_i_id()));
	...
	private void dto2Components() throws Throwable {
		...
		Integer iId = getTabbedPaneSerienbrief().getSerienbriefselektionDto()
				.getSelektionIId();
		SelektionDto selektionDto = null;
		if (iId != null) {
			selektionDto = DelegateFactory.getInstance()
