 ...
 */
public class PanelDialogKriterienUmsatzKD
    extends PanelDialogKriterienUmsatz
{
...
public PanelDialogKriterienUmsatzKD(InternalFrame oInternalFrameI,
                                      String title,
  ...
  protected void eventActionSpecial(ActionEvent e)
    ...
    if (e.getActionCommand().equals(ACTION_SPECIAL_CLOSE_PANELDIALOG)) {
      ( (InternalFrameKunde) getInternalFrame()).gotoAuswahl();
    }
  }
