...
//von hier ...
  ...
  public PanelKontaktart(InternalFrame internalFrame, String add2TitleI,
                         Object pk)
      throws Throwable {
  ...
  public void eventActionNew(EventObject eventObject, boolean bLockMeI,
    ...
    kontaktartDto = new KontaktartDto();
  ...
  protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI,
      ...
      throws Throwable {
    DelegateFactory.getInstance().getPartnerServicesDelegate().removeKontaktart(kontaktartDto);
  ...
  protected void components2Dto() {
    kontaktartDto.setCBez(wtfBezeichnung.getText());

  }


  protected void dto2Components() {
    wtfBezeichnung.setText(kontaktartDto.getCBez());
  ...
  public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
    ...
    if (allMandatoryFieldsSetDlg()) {
      components2Dto();
      if (kontaktartDto.getIId() == null) {
        kontaktartDto.setIId(DelegateFactory.getInstance().getPartnerServicesDelegate().createKontaktart(
            kontaktartDto));
        setKeyWhenDetailPanel(kontaktartDto.getIId());
      }
      else {
        DelegateFactory.getInstance().getPartnerServicesDelegate().updateKontaktart(kontaktartDto);
      }
      super.eventActionSave(e, true);
      if (getInternalFrame().getKeyWasForLockMe() == null) {
        getInternalFrame().setKeyWasForLockMe(kontaktartDto.getIId() + "");
      }
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_KONTAKTART;
  }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      kontaktartDto = DelegateFactory.getInstance().getPartnerServicesDelegate().
