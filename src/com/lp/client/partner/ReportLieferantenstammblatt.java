...
public class ReportLieferantenstammblatt extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public String getReportname() {
		return LieferantReportFac.REPORT_LIEFERANTENSTAMMBLATT;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getLieferantDelegate()
				.printLieferantenstammblatt(lieferantIId);
	}
