...
public class ReportPartnerstammblatt extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportPartnerstammblatt(InternalFrame internalFrame,Integer partnerIId,
	...
	public String getReportname() {
		return PartnerReportFac.REPORT_PART_PARTNERSTAMMBLATT;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getKundeDelegate()
				.printPartnerstammblatt(partnerIId);
	}
