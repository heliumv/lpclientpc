...
//von hier ...
  ...
  private ThemaDto themaDto = null;

  public PanelThema(InternalFrame internalFrame, String add2TitleI,
                           Object pk)
      throws Throwable {
  ...
  protected void dto2Components() {
    wtfBezeichnung.setText(themaDto.getCBez());
    wtfKennung.setText(themaDto.getCNr());
  }


  protected void components2Dto() {
    themaDto.setCBez(wtfBezeichnung.getText());
  ...
  protected String getLockMeWer()
      throws Exception {
    return HelperClient.LOCKME_THEMA;
  }
  ...
  public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
    ...
    if (key == null
      ...
      themaDto = DelegateFactory.getInstance().getBenutzerDelegate().
          themaFindByPrimaryKey( (String) key);
      dto2Components();
    }
	  ...
	  if (allMandatoryFieldsSetDlg()) {
			...
			components2Dto();
				...
				DelegateFactory.getInstance().getBenutzerDelegate()
						.updateThema(themaDto);
			
			super.eventActionSave(e, true);
			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame()
						.setKeyWasForLockMe(themaDto.getCNr());
			}
