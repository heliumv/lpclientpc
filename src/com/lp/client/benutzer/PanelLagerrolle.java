...
public class PanelLagerrolle extends PanelBasis {
	...
	private LagerrolleDto lagerolleDto = null;
	...
	public PanelLagerrolle(InternalFrame internalFrame, String add2TitleI,
	...
	protected void dto2Components() throws ExceptionLP, Throwable {
		LagerDto lagerDto = DelegateFactory.getInstance().getLagerDelegate()
				.lagerFindByPrimaryKey(lagerolleDto.getLagerIId());
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || (key.equals(LPMain.getLockMeForNew()))) {
			...
			lagerolleDto = DelegateFactory.getInstance().getBenutzerDelegate()
					.lagerrolleFindByPrimaryKey((Integer) key);
			dto2Components();
	...
	protected void eventItemchanged(EventObject eI) throws Throwable {
		...
		if (e.getID() == ItemChangedEvent.GOTO_DETAIL_PANEL) {
			if (e.getSource() == panelQueryFLRLager) {
				...
				wtfLager.setText(lagerDto.getCNr());
				lagerolleDto.setLagerIId(lagerDto.getIId());
			}
		}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			components2Dto();
			if (lagerolleDto.getIId() == null) {
				lagerolleDto.setSystemrolleIId(internalFrameBenutzer
						.getSystemrolleDto().getIId());
				lagerolleDto.setIId(DelegateFactory.getInstance()
						.getBenutzerDelegate().createLagerrolle(lagerolleDto));
				setKeyWhenDetailPanel(lagerolleDto.getIId());
			} else {
				DelegateFactory.getInstance().getBenutzerDelegate()
						.updateLagerrolle(lagerolleDto);
			}
	...
	private void jbInit() throws Throwable {
		...
		this.add(getPanelStatusbar(), new GridBagConstraints(0, 2, 1, 1, 1.0,
				...
				new Insets(0, 0, 0, 0), 0, 0));
		jpaWorkingOn.add(wbuLager, new GridBagConstraints(0, 0, 1, 1, 0.05,
